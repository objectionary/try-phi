var app = (function (exports) {
    ...
    */
    ...
    const parser = LRParser.deserialize({
      version: 13,
      states: ".^OQOPOOO]OPO'#DaObOPO'#C_OmOPO'#DbOrOPO'#CbOzOPO'#C^O!YOPO'#C^O!_OPO'#C^QOOOOOOOOO,59{,59{OOOO-E7_-E7_OOOO,59|,59|OOOO-E7`-E7`O!gOPO'#DdOzOPO'#DcOOOO'#De'#DeO!lOPO'#CeO#yOPO'#CgO$ROPO'#CfOOOO'#Dc'#DcO$WOPO'#DcO$`OPO'#CdOOOO,58x,58xOzOPO,58xO$qOPO,58xOOOO,5:O,5:OOOOO-E7b-E7bOOOO,59},59}O$WOPO,59}OOOO-E7c-E7cO$vOPO,59RO%OOPO,59RO!TOPO,59QOOOO-E7a-E7aOOOO1G.d1G.dOzOPO1G.dOOOO1G/i1G/iO%TOPO1G.mO%]OQO1G.mO%bOPO1G.mO&nOPO'#DgO&xOPO1G.lOOOO7+$O7+$OO'ZOPO7+$XO'`OPO7+$XO'eOPO7+$XO'mOQO7+$XO'rOPO'#CnO'zOPO'#C|OOOO'#C|'#C|O(]OPO'#DhO(nOPO'#D]O(|OPO'#CxOOOO'#DQ'#DQO)WOPO'#D^OOOO'#D['#D[OOOO'#D_'#D_OOOO'#Cu'#CuO)fOPO'#CuO)pOPO'#CtO){OPO'#CsOOOO'#Cr'#CrOOOO,5:R,5:ROOOO-E7e-E7eOOOO<<Gs<<GsO*QOPO<<GsO'ZOPO<<GsO*VOPO<<GsOOOO,59Y,59YO*[OQO,59YOOOO,59b,59bOOOO,5:S,5:SOOOO-E7f-E7fO*gOPO'#C|O*xOPO,59dO*}OPO,59xO+[OPO,59xOOOO,59a,59aO(|OPO'#DiO+jOPO,59`OOOO,59_,59_O+uOPOAN=_OOOOAN=_AN=_O+}OPOAN=_O,SOPO'#DfO,XOQO1G.tOOOO1G.t1G.tO,dOPO1G.tO,iOPO1G/OOOOO,5:T,5:TOOOO-E7g-E7gO'ZOPOG22yO,wOPOG22yOOOO,5:Q,5:QOOOO-E7d-E7dOOOO7+$`7+$`O-POPO7+$`O-UOPO7+$jOOOOLD(eLD(eO'ZOPOLD(eOOOO<<Gz<<GzOOOO!$'LP!$'LP",
      stateData: "-d~OSPOTTOVRO~OTXO~OSPOTRXVRX~OTZO~OVROTUX~OS]O[aO]aO!__O~OTgO~OTgOVRO~OTiO~O!__O[XX]XXcXXmXXoXXqXXrXXsXXuXXvXXwXXxXXyXXzXX{XX|XX}XX!SXX~O^oO!_nO~OTpO~O[aO]aO~OS]O[aO]aO!__O!^WX~OTsO~O_vOauO~O!_wO~O!_{OTZi~O`|O~O_!OOa}O~Oc!POm!UOo!SOq!ROr!ROs!ROu!VOv!VOw!VOx!VOy!VOz!VO{!VO|!VO}!VO!S!YO~O[!QO]!QO~P%jO!__OSYi[Yi]Yi!^Yi~Oc!PO~O!_!cO~O!_!dOTZq~O`!eO~O[!gOe!fO~O^oOk!hO!_nOTpXopX~O[!RO]!ROq!ROr!ROs!RO~Oo!SOT!PX!_!PXn!PX~O[!kO]!kO~P%jOo!mOT!QX!_!QXn!QX~O[!RO]!RO~P%jO!_!pOThXnhX~OT!rO~Oa!sO~O!_!uO~Od!yOe!xO!_!vO~Ok!hOnpXopX!_pXTpX~On!zO~OT!Qa!_!Qan!Qa~P(]Oo!SOT!Qa!_!Qan!Qa~O!_!pOThanha~O!_!}OTZ!R~Oa#OO~O[#PO~Od#SOe#RO!_!vO~Oe#RO~Oo!SOTli!_linli~O!_#VOTZ!Z~Oe#WO~Oo!SOTlq!_lqnlq~O",
      goto: "&o!^PP!_!bPP!eP!k!t#R#cPPPPPP#mPPP$P#`$S$Y$aP$fPPP$nPPP$fPPPPPPPPP$f$x$x$fP%O%U%]%e%n%z&Q&W&iRWORVOQUORhVQfTQrgRzsWdTegsQl^TxpyWcTegsSk^dQtlR!_xabT^deglsxW!Yx!U![!pQ!b{Q!t!dQ#U!}R#X#VR!`xQ!^xR!l!US!]x!UR!{!pV![x!U!pU!Zx!U!pR!o![W!Wx!U![!pT!i!S!mX!Xx!U![!pQQORYQSSOVR[SUeTgsRqeW^TegsRj^^`T^egpsyRm`Q!w!gR#Q!wQypR!ayW!Tx!U![!pU!j!T!n#TQ!n!WR#T!zQ!q!]R!|!q",
      nodeNames: "⚠ PhiGrammar PROGRAM LICENSE COMMENT EOL METAS META OBJECTS SPACES OBJECT DECLARATION FREE_NAME AT CONST SLASH FOREIGN_NAME ARROW ATTRIBUTE_LIST LSQ DOTS RSQ DEFINITION INLINE_EXPRESSION INLINE INLINE_TOKEN ARGUMENT COLON PARENTHESIZED LB RB DOT DOT_NAME RHO XI SIGMA DATA BYTES BOOL TEXT STRING INT FLOAT HEX CHAR REGEX ACTION DOT_ACCESS MAYBE_INVERSE ANONYMOUS ARRAY_STAR",
      maxTerm: 61,
      nodeProps: [
        [NodeProp.closedBy, 19,"RSQ",29,"RB"],
        [NodeProp.openedBy, 21,"LSQ",30,"LB"]
      ],
      skippedNodes: [0],
      repeatNodeCount: 9,
      tokenData: "7Y~RkYZ!vpq!{qr#Qrs#Vst*wtu+Vvw+[wx+axy.]yz.bz{.g{|.l}!O1S!O!P1e!P!Q1x!Q!R3O!R![4a![!]5P!`!a5U!b!c5Z!c!h3r!h!i5`!v!w6Y!}#O6f#P#Q6k#Q#R6p#T#o6u~!{OT~~#QO!_~~#VO^~~#YVOY#oZ]#o^r#ors&hs#O#o#O#P$^#P~#o~#rVOY#oZ]#o^r#ors$Xs#O#o#O#P$^#P~#o~$^Ox~~$a[rs#owx#o!Q!R%V!R!S%V!S!T%c#O#P#o#U#V#o#Y#Z#o#b#c#o#f#g#o#h#i#o#i#j%r~%YP!Q![%]~%`P!Q![#o~%fQ!Q!V%]!V!W%l~%oP!Q!W#o~%uQ!Q![%{!c!i%{~&OQ!Q![&U!c!i&U~&XQ!Q![&_!c!i&_~&bQ!Q![#o!c!i#o~&mPx~rs&p~&sQYZ&y]^*q~&|TOr&yrs']s#O&y#O#P(g#P~&y~'`TOr&yrs'os#O&y#O#P(g#P~&y~'rTOr&yrs(Rs#O&y#O#P(g#P~&y~(WTw~Or&yrs(Rs#O&y#O#P(g#P~&y~(j[rs&ywx&y!Q!R)`!R!S)`!S!T)l#O#P&y#U#V&y#Y#Z&y#b#c&y#f#g&y#h#i&y#i#j){~)cP!Q![)f~)iP!Q![&y~)oQ!Q!V)f!V!W)u~)xP!Q!W&y~*OQ!Q![*U!c!i*U~*XQ!Q![*_!c!i*_~*bQ!Q![*h!c!i*h~*kQ!Q![&y!c!i&y~*tPYZ&y~*|RS~OY*wZ]*w^~*w~+[Or~~+aOs~~+dUOY+vZ]+v^r+vs#O+v#O#P,R#P~+v~+yPwx+|~,RO|~~,U[rs+vwx+v!Q!R,z!R!S,z!S!T-W#O#P+v#U#V+v#Y#Z+v#b#c+v#f#g+v#h#i+v#i#j-g~,}P!Q![-Q~-TP!Q![+v~-ZQ!Q!V-Q!V!W-a~-dP!Q!W+v~-jQ!Q![-p!c!i-p~-sQ!Q![-y!c!i-y~-|Q!Q![.S!c!i.S~.VQ!Q![+v!c!i+v~.bOm~~.gOn~~.lO!S~~.oR!Q!R.x!R![/w#T#o0S~.}Py~!O!P/Q~/VQz~!Q![/Q#X#Y/]~/`R{|/i}!O/i!Q![/o~/lP!Q![/o~/tPz~!Q![/o~/|Qy~!O!P/Q!Q![/w~0XTV~pq0h}!O0S!Q![0S#R#S0S#T#o0S~0kROY0tZ]0t^~0t~0yRV~OY0tZ]0t^~0t~1VR}!O1`!Q!R.x!R![/w~1eOu~R1jPoP!O!P1mQ1pP!O!P1sQ1xOdQ~1}R_~OY2WZ]2W^~2W~2ZTOY2WZ]2W^!P2W!P!Q2j!Q~2W~2oT}~OY2WZ]2W^!P2W!P!Q2j!Q~2W~3TSy~!O!P/Q!Q![3a!c!i3a#l#m3{~3fPu~}!O3i~3lQ!Q![3r!c!i3r~3uQ!Q![3a!c!i3a~4OQ!Q![4U#T#Z4U~4ZQ{~!Q![4U#T#Z4U~4fRy~!O!P/Q!Q![4o!c!i3a~4vRu~y~}!O3i!O!P/Q!Q![/w~5UOk~~5ZOa~~5`O]~~5cR!Q![3a!c!d5l!d!i3a~5qQu~}!O3i!n!o5w~5zP!u!v5}~6QP!g!h6T~6YOv~~6]P!t!u6`~6cP!w!x5}~6kOc~~6pOe~~6uOq~R6|S`Q[P}!O6u!Q![6u#R#S6u#T#o6u",
      tokenizers: [0, 1],
