...
<button class=${themeClass("button")} type=submit>${view.state.phrase("go")}</button>`;
    ...
    const parser = Parser.deserialize({
      version: 13,
      states: "#rOVQPOOO_QPO'#CdQgQPOOOOQO'#Cj'#CjOoQPO'#ClOOQO,59O,59OOtQPO,59OO|QPO,59UO!RQPO,59UOOQO'#C`'#C`OVQPO,59WO!RQPO'#CfO!WQPO1G.jOOQO1G.j1G.jOOQO1G.p1G.pO!`QPO1G.pO!eQPO1G.rOOQO,59Q,59QOOQO-E6d-E6dOOQO7+$U7+$UOOQO7+$[7+$[",
      stateData: "!v~O]OS~OVPOXRO~OQSOUTO~ORWO_VO~OaXO~OU]ObZO~OQ^O~OQSO~OUcObZO~OTdO~ORWO_VOU`ib`iT`i~O",
      goto: "!OaPPPPbPPPePiPPPoPuRYSTROYQ[URb[QQOR`YQUPQ_WRaZ",
      nodeNames: "⚠ PhiGrammar Attr ( Mapsto ) ] [ BlockBody Locator",
      maxTerm: 18,
      nodeProps: [
        [NodeProp.openedBy, 6,"["],
        [NodeProp.closedBy, 7,"]"]
      ...
      skippedNodes: [0],
      repeatNodeCount: 1,
      tokenData: "%R~RfXY!gYZ!gZ^!gpq!gxy#byz#g|}#l}!O#q!O!P#|!c!}$R!}#O$a#P#Q$f#Q#R$k#T#o$R#y#z!g$f$g!g#BY#BZ!g$IS$I_!g$I|$JO!g$JT$JU!g$KV$KW!g&FU&FV!g~!l[]~XY!gYZ!gZ^!gpq!g#y#z!g$f$g!g#BY#BZ!g$IS$I_!g$I|$JO!g$JT$JU!g$KV$KW!g&FU&FV!g~#gOR~~#lOT~~#qOb~~#tP!`!a#w~#|Oa~~$RO_~~$WRQ~!Q![$R!c!}$R#T#o$R~$fOV~~$kOU~~$nQ!Q!R$t!R![$y~$yOX~~%OPX~!Q![$y",
      tokenizers: [0],
