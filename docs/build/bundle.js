var app = (function (exports) {
    ...
    */
    ...
    const parser = LRParser.deserialize({
      version: 13,
      states: "1WOcOPOOOmOPO'#DdOrOPO'#C_O!ZOPO'#DeO!`OPO'#CbO!wOPO'#DfOOOO'#Dh'#DhO#YOPO'#CeO#hOPO'#ChO#pOPO'#CoO#xOPO'#CgOOOO'#Cg'#CgO$QOPO'#CfO$VOPO'#DfO$nOPO'#DfO$yOPO'#CdOOOO'#C^'#C^O!wOPO'#C^O%QOPO'#C^O%XOPO'#C^QOOOOOO%cOPO,5:OO%zOPO'#DdOOOO-E7b-E7bOOOO,5:P,5:POOOO-E7c-E7cO&POPO'#DgOOOO-E7e-E7eO&UOPO,5:QO$nOPO,5:QOOOO-E7f-E7fO&mOPO,59SO&uOPO,59SOOOO,59Z,59ZO&zOPO,59ZO$tOPO,59RO^OPO,59QOOOO'#Dp'#DpO&UOPO,5:QOOOO-E7d-E7dOOOO,58x,58xO!wOPO,58xO'VOPO,58xOOOO,5:O,5:OOOOO,5:R,5:RO'^OPO1G/lO'^OPO1G/lOOOO1G.n1G.nO'uOQO1G.nO'zOPO1G.nO(SOPO'#DiO(XOPO1G.uOOOO1G.u1G.uO(dOPO1G.uOOOO1G.m1G.mO(iOSO'#CeO*tOSO'#DjO+OOPO1G.lOOOO-E7n-E7nOOOO1G.d1G.dO!wOPO1G.dO+gOPO7+%WO,OOPO7+$YOOOO7+$Y7+$YO,TOQO7+$YOOOO,5:T,5:TOOOO-E7g-E7gOOOO7+$a7+$aO,YOPO7+$aO,_OQO'#DQOOOO'#DQ'#DQO,sOSO'#CyOOOO'#DU'#DUO-QOPO'#DmO-cOQO'#DaO-qOQO'#DcOOOO'#D`'#D`OOOO'#Cv'#CvO.POSO'#CvO.vOPO'#CuO/ROPO'#CtOOOO'#Cs'#CsOOOO,5:U,5:UOOOO-E7h-E7hOOOO7+$O7+$OO/WOPO<<GtO/]OPO<<GtOOOO<<G{<<G{OOOO,59c,59cO/bOQO'#DQO/sOPO'#C{O1POSO'#C{O1WOPO,59eOOOO,5:X,5:XOOOO-E7k-E7kO1]OPO,59|O1jOQO,59}OOOO,59b,59bO/{OSO'#DoO1xOPO,59aOOOO,59`,59`OOOOAN=`AN=`O2TOPOAN=`O2YOPO'#DkO2_OPO,59gOOOO,59g,59gO2gOQO1G/POOOO,5:Y,5:YO-QOPO'#DnOOOO-E7l-E7lOOOO,5:Z,5:ZOOOO-E7m-E7mOOOOG22zG22zO$nOPO'#C|OOOO,5:V,5:VOOOO-E7i-E7iO-QOPO'#DlO2uOQO7+$kO3TOPO,59hOOOO,5:W,5:WOOOO-E7j-E7jO/{OSO1G/SO3YOPO7+$nOOOO<<HY<<HY",
      stateData: "3_~OVRO]WO^WOdXO!fUO~OSPOTaO~PQOTeO~OSfOTRXVRX]RX^RXdRX!fRX~OThO~OVROSUXTUX]UX^UXdUX!fUX~OSjO]WO^WOdXO!fUO~O!fUO]XX^XXdXX~O_pO!foO~O]rOfqO~O!fsOTZX~OTtO~OTuOS!YX]!YX^!YXd!YX!e!YX!f!YX~O]WO^WOdXO~O!eWX~P!wOTyO~P!wOSjOTyO~PQOS!ZaT!WaV!Wa]!Za^!Zad!Za!f!Za~OT{O~OT|O~OTuOS!Ya]!Ya^!Yad!Ya!e!Ya!f!Ya~O`!QOb!PO~O!f!RO~Oe!VOf!UO!f!SO~OT!^O~P!wOTuOS!Yi]!Yi^!Yid!Yi!e!Yi!f!Yi~Oa!`O~O`!bOb!aO~O]!cO~Oe!fOf!eO!f!SO~Of!eO~O!fUO]XX^XXdXXnXXsXXuXXvXXwXXyXXzXX{XX|XX}XX!OXX!PXX!QXX!RXX~OdXOn!iOs!kOu!hOv!hOw!hOy!jOz!jO{!jO|!jO}!jO!O!jO!P!jO!Q!jO!R!jO~O]!gO^!gO~P)sO!fUOSYiTYi]Yi^YidYi!eYi~OTuOS!Yq]!Yq^!Yqd!Yq!e!Yq!f!Yq~O!f!wO~Oa!xO~Of!yO~O_pOl!zO!foOTtXstX!ftX~O]!{O^!{Or!}O~P)sO]!hO^!hOu!hOv!hOw!hO~Os!kOT!TX!f!TXq!TX~Os#ROT!VX!f!VXq!VX~On!iOs!kOy!jOz!jO{!jO|!jO}!jO!O!jO!P!jO!Q!jO!R!jO~P-QO!f#UOTiXqiX~OT#WO~Ob#XO~O!f#YO~Ol!zOqtXstX!ftXTtX~O!f#ZOqoX~O]!{O^!{On!iOs!kOu!hOv!hOw!hOy!jOz!jO{!jO|!jO}!jO!O!jO!P!jO!Q!jO!R!jO~OqoX~P/{Oq#^O~OT!Ua!f!Uaq!Ua~P-QOs#`OT!Va!f!Vaq!Va~O!f#UOTiaqia~Ob#dO~On#eO~O!f#ZOqoa~Os#hOTmi!fmiqmi~Os#hOTmq!fmqqmq~O!f#mO~Oq#oO~O",
      goto: ")W!ePP!f!iPP!lP!r#R#d#x$ZPPPPPP$jPPP%P#u%S%`%iP%pP%z%}PPP&QPPP%pPPPPPPPPP%p&d&d&d&l&r&y'V'd'w'}(T(Z(a(l(r(xRdORcOQbORzcQ`OUxabcS!]yzR!v!^`^O_abcyz!^QmTT!Yt!Z`]O_abcyz!^SlT^Q!OmR!s!Yh[OT^_abcmyz!Y!^R#j#ekYOT^_abcmyz!Y!^#ejZOT^_abcmyz!Y!^#eQ!WsR!|!iR!t!YQ!r!YQ#O!iQ#]!}R#n#mW!q!Y!i!}#mR#b#UZ!p!Y!i!}#U#mY!o!Y!i!}#U#mR#T!pR#O!iR#f#Z[!m!Y!i!p!}#U#mQ#P!kS#_#R#`R#k#h]!n!Y!i!p!}#U#mQQORgQSSOcRiS^_Oabcyz!^Rw_`TO_abcyz!^RkTbVOT_abcyz!^SnV!XT!Xt!ZQ!TrR!d!TQ!ZtR!u!ZQ#[!|R#g#[Q#i#^R#l#i[!l!Y!i!p!}#U#mR#Q!lQ#S!mR#a#SQ#V!qR#c#VQv]Q}lU![v}!_R!_!O",
      nodeNames: "⚠ PhiGrammar PROGRAM LICENSE COMMENT EOL METAS META OBJECTS SPACES OBJECT DECLARATION ATTR_NAME FREE_NAME AT CONST SLASH FOREIGN_NAME ARROW FREE_LIST LSQ DOTS RSQ DEFINITION INLINE_EXPRESSION INLINE INLINE_TOKEN ARGUMENT COLON PARENTHESIZED LB ANONYMOUS INLINE_ATTRIBUTE RB ARRAY_STAR DOT DOT_NAME RHO XI SIGMA DATA BYTES BOOL TEXT STRING INT FLOAT HEX CHAR REGEX ACTION DOT_ACCESS INVERSE_DOT APPLICATION",
      maxTerm: 68,
      nodeProps: [
      ...
      skippedNodes: [0],
      repeatNodeCount: 13,
      tokenData: "7Y~RkYZ!vpq!{qr#Qrs#Vst*wtu+Vvw+[wx+axy.]yz.bz{.g{|.l}!O1S!O!P1e!P!Q1x!Q!R3O!R![4a![!]5P!`!a5U!b!c5Z!c!h3r!h!i5`!v!w6Y!}#O6f#P#Q6k#Q#R6p#T#o6u~!{OT~~#QO!f~~#VO_~~#YVOY#oZ]#o^r#ors&hs#O#o#O#P$^#P~#o~#rVOY#oZ]#o^r#ors$Xs#O#o#O#P$^#P~#o~$^O|~~$a[rs#owx#o!Q!R%V!R!S%V!S!T%c#O#P#o#U#V#o#Y#Z#o#b#c#o#f#g#o#h#i#o#i#j%r~%YP!Q![%]~%`P!Q![#o~%fQ!Q!V%]!V!W%l~%oP!Q!W#o~%uQ!Q![%{!c!i%{~&OQ!Q![&U!c!i&U~&XQ!Q![&_!c!i&_~&bQ!Q![#o!c!i#o~&mP|~rs&p~&sQYZ&y]^*q~&|TOr&yrs']s#O&y#O#P(g#P~&y~'`TOr&yrs'os#O&y#O#P(g#P~&y~'rTOr&yrs(Rs#O&y#O#P(g#P~&y~(WT{~Or&yrs(Rs#O&y#O#P(g#P~&y~(j[rs&ywx&y!Q!R)`!R!S)`!S!T)l#O#P&y#U#V&y#Y#Z&y#b#c&y#f#g&y#h#i&y#i#j){~)cP!Q![)f~)iP!Q![&y~)oQ!Q!V)f!V!W)u~)xP!Q!W&y~*OQ!Q![*U!c!i*U~*XQ!Q![*_!c!i*_~*bQ!Q![*h!c!i*h~*kQ!Q![&y!c!i&y~*tPYZ&y~*|RS~OY*wZ]*w^~*w~+[Ov~~+aOw~~+dUOY+vZ]+v^r+vs#O+v#O#P,R#P~+v~+yPwx+|~,RO!Q~~,U[rs+vwx+v!Q!R,z!R!S,z!S!T-W#O#P+v#U#V+v#Y#Z+v#b#c+v#f#g+v#h#i+v#i#j-g~,}P!Q![-Q~-TP!Q![+v~-ZQ!Q!V-Q!V!W-a~-dP!Q!W+v~-jQ!Q![-p!c!i-p~-sQ!Q![-y!c!i-y~-|Q!Q![.S!c!i.S~.VQ!Q![+v!c!i+v~.bOn~~.gOq~~.lOr~~.oR!Q!R.x!R![/w#T#o0S~.}P}~!O!P/Q~/VQ!O~!Q![/Q#X#Y/]~/`R{|/i}!O/i!Q![/o~/lP!Q![/o~/tP!O~!Q![/o~/|Q}~!O!P/Q!Q![/w~0XTV~pq0h}!O0S!Q![0S#R#S0S#T#o0S~0kROY0tZ]0t^~0t~0yRV~OY0tZ]0t^~0t~1VR}!O1`!Q!R.x!R![/w~1eOy~V1jPsU!O!P1mP1pP!O!P1sP1xOeP~1}R`~OY2WZ]2W^~2W~2ZTOY2WZ]2W^!P2W!P!Q2j!Q~2W~2oT!R~OY2WZ]2W^!P2W!P!Q2j!Q~2W~3TS}~!O!P/Q!Q![3a!c!i3a#l#m3{~3fPy~}!O3i~3lQ!Q![3r!c!i3r~3uQ!Q![3a!c!i3a~4OQ!Q![4U#T#Z4U~4ZQ!P~!Q![4U#T#Z4U~4fR}~!O!P/Q!Q![4o!c!i3a~4vRy~}~}!O3i!O!P/Q!Q![/w~5UOl~~5ZOb~~5`O^~~5cR!Q![3a!c!d5l!d!i3a~5qQy~}!O3i!n!o5w~5zP!u!v5}~6QP!g!h6T~6YOz~~6]P!t!u6`~6cP!w!x5}~6kOd~~6pOf~~6uOu~V6|SaQ]T}!O6u!Q![6u#R#S6u#T#o6u",
      tokenizers: [0, 1, 2],
