...
<button class=${themeClass("button")} type=submit>${view.state.phrase("go")}</button>`;
    ...
    const parser = Parser.deserialize({
      version: 13,
      states: "$OOVQPOOO_QPO'#CfQjQPOOOOQO'#Cl'#ClOrQPO'#CnOOQO,59Q,59QOwQPO,59QO!PQPO'#CaO![QPO,59WOOQO,59W,59WOOQO'#Cc'#CcOVQPO,59YO!aQPO'#ChO!iQPO1G.lOOQO1G.l1G.lOOQO,58{,58{O!qQPO,58{OOQO1G.r1G.rO!vQPO1G.tOOQO,59S,59SOOQO-E6f-E6fOOQO7+$W7+$WOOQO1G.g1G.g",
      stateData: "#X~O_OS~OXPOZRO~OQSOUSOWTO~OSVOaWO~OcYO~OW^Od[O~OQSOR_OUSO~OQaO~OQSOUSO~OWeOd[O~ORfO~OSVOaWOWbidbiRbi~O",
      goto: "!UcPPPPPdPhPPkPoPPPuP{TXQbRZSTROZQ]URd]QQORbZQUPQ`VRc[",
      nodeNames: "⚠ PhiGrammar Attr ) ( Block Decorator Mapsto ] [ Block Locator",
      maxTerm: 20,
      nodeProps: [
        [NodeProp.openedBy, 3,"(",8,"["],
        [NodeProp.closedBy, 4,")",9,"]"]
      ],
      skippedNodes: [0],
      repeatNodeCount: 1,
