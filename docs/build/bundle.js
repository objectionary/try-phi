var app = (function (exports) {
    ...
    */
    ...
    const parser = LRParser.deserialize({
      version: 13,
      states: "1WO!bOPOOO!lOPO'#DaO!qOPO'#C_O$XOPO'#DbO$^OPO'#CbO%tOPO'#DcO'UOPO'#CeO(cOPO'#ChO(kOPO'#CqO*QOPO'#CqO(vOPO'#CoOOOO'#Ct'#CtOOOO'#DP'#DPO*bOPO'#DiO*sOPO'#DUO+UOPO'#DWO+gOPO'#CnO+jOPO'#CnO+xOPO'#CmO,TOPO'#CgO,YOPO'#CfO,_OPO'#DcO(vOPO'#DcO-uOPO'#CdOOOO'#C^'#C^O%tOPO'#C^O-|OPO'#C^O.TOPO'#C^QOOOOOO._OPO'#DeO.dOPO,59{O/zOPO'#DaOOOO-E7_-E7_OOOO,59|,59|OOOO-E7`-E7`O0POPO'#DdOOOO-E7b-E7bO0UOPO,59}O(vOPO,59}OOOO-E7c-E7cOOOO,59S,59SO1lOQO,59SO1wOPO,59RO2POPO,59]O2_OPO'#CqOOOO,59],59]OOOO'#Cn'#CnO2mOPO,59ZO2rOPO,59ZOOOO,5:T,5:TOOOO-E7g-E7gO2}OPO,59qO3_OPO,59rO*bOPO'#DhO3pOPO,59YO*bOPO,59YO(vOPO'#DkO4ROPO,59XO1zOPO,59RO4^OPO,59QOOOO'#Dm'#DmO0UOPO,59}OOOO-E7a-E7aOOOO,58x,58xO%tOPO,58xO5tOPO,58xOOOO,5:P,5:POOOO,59{,59{OOOO,5:O,5:OO5{OPO1G/iO5{OPO1G/iO7cOPO'#DfO7hOQO1G.nOOOO1G.n1G.nO7sOPO1G.nO(vOPO,5:RO7xOPO1G.mO7}OPO'#DgOOOO-E7e-E7eOOOO1G.u1G.uOOOO,5:U,5:UO*bOPO'#DjOOOO-E7h-E7hOOOO,5:S,5:SOOOO-E7f-E7fO*bOPO1G.tOOOO1G.t1G.tOOOO,5:V,5:VOOOO-E7i-E7iO(vOPO'#DlO8SOPO1G.lOOOO-E7k-E7kOOOO1G.d1G.dO%tOPO1G.dO9jOPO7+%TOOOO,5:Q,5:QOOOO-E7d-E7dOOOO7+$Y7+$YO;QOPO7+$YO;VOPO1G/mO*bOPO7+$XOOOO7+$`7+$`O;[OPO'#D`OOOO'#D_'#D_OOOO,5:W,5:WOOOO-E7j-E7jOOOO7+$O7+$OOOOO<<Gt<<GtOOOO7+%X7+%XO;dOPO'#DZOOOO<<Gs<<GsOOOO,59z,59zO;rOPO,59uO;wOPO,59uO<SOQO1G/aO<XOPO1G/aOOOO7+${7+${O<^OQO7+${OOOO<<Hg<<HgO<cOPO'#CnO<tOPO,59YO(vOPO'#DkO=VOPO,59XO=eOPO'#Cm",
      stateData: "=s~OVRO]VO^[OdYOgXOiZOjZOkZOlZOmZOnZOoZOpZOqZOr]Ot[Ou[Ov[Ow[O!cmO~OSPOTiO~PQOTnO~OSoOTRXVRX]RX^RXdRXgRXiRXjRXkRXlRXmRXnRXoRXpRXqRXrRXtRXuRXvRXwRX!cRX~OTqO~OVROSUXTUX]UX^UXdUXgUXiUXjUXkUXlUXmUXnUXoUXpUXqUXrUXtUXuUXvUXwUX!cUX~OSsO]VO^[OdYOgXOiZOjZOkZOlZOmZOnZOoZOpZOqZOr]Ot[Ou[Ov[Ow[O!cmO~O!cmO]XX^XXdXXgXXiXXjXXkXXlXXmXXnXXoXXpXXqXXrXXtXXuXXvXXwXX~O^yO`xO~O!czO{eXTeX~O]VO^[OdYOgXOiZOjZOkZOlZOmZOnZOoZOpZOqZOr]Ot[Ou[Ov[Ow[O~O{eX!ceXfeXTeX~P(vO^[Ot[Ou[Ov[Ow[O~Or]O{xX!cxXfxXTxX~Or!TO{zX!czXfzXTzX~Or!VO{!XO!cbXfbXTbX~O!c!YOfaXTaX~O!c![O~OT!]O~OT!^OS!VX]!VX^!VXd!VXg!VXi!VXj!VXk!VXl!VXm!VXn!VXo!VXp!VXq!VXr!VXt!VXu!VXv!VXw!VX!b!VX!c!VX~O!bWX~P%tOT!bO~P%tOSsOT!bO~PQO!c!dO~OS!WaT!TaV!Ta]!Wa^!Wad!Wag!Wai!Waj!Wak!Wal!Wam!Wan!Wao!Wap!Waq!War!Wat!Wau!Wav!Waw!Wa!c!Wa~OT!eO~OT!fO~OT!^OS!Va]!Va^!Vad!Vag!Vai!Vaj!Vak!Val!Vam!Van!Vao!Vap!Vaq!Var!Vat!Vau!Vav!Vaw!Va!b!Va!c!Va~O_!lO`!kO!c!iO~Od!mO|!nO~O!c!oO{eafeaTea~O!c!oO{eXfeXTeX~Of!qO~O{!XOfbX!cbX~O{ya!cyafyaTya~P*bOr!sO{za!czafzaTza~Or!VO{!wO!cbafbaTba~O!c!YOfaaTaa~O!cmOSYaTYa]Ya^YadYagYaiYajYakYalYamYanYaoYapYaqYarYatYauYavYawYa!bYa~OT#PO~P%tOT!^OS!Vi]!Vi^!Vid!Vig!Vii!Vij!Vik!Vil!Vim!Vin!Vio!Vip!Viq!Vir!Vit!Viu!Viv!Viw!Vi!b!Vi!c!Vi~O^#RO~O_#UO`#TO!c!iO~O`#TO~O!c#WO~Od!mO~O!cmOSYiTYi]Yi^YidYigYiiYijYikYilYimYinYioYipYiqYirYitYiuYivYiwYi!bYi~OT!^OS!Vq]!Vq^!Vqd!Vqg!Vqi!Vqj!Vqk!Vql!Vqm!Vqn!Vqo!Vqp!Vqq!Vqr!Vqt!Vqu!Vqv!Vqw!Vq!b!Vq!c!Vq~O`#_O~Of#`O~OT#cO!c![O~O!O#eO!c#dOT}Xf}X~O!P#fO~O!c#gOT}af}a~O!Q#hO~O!P#iO~O!Q#jO~Or!VO{bX!cbXfbXTbX~Or!VO{ba!cbafbaTba~O!c#mO{aafaaTaa~O!c#mO{aXfaXTaX~O",
      goto: "*{!bPP!c!fPP!iP!o#O#a#u$WPPPP$m%U%mP&SPP%mPPPPPPPPPP&kPPPP'c'c'cPP'xPPP'{#r(O(U(](i(v)W)^)e)o*V*]*g*mRlORkOQjOR!ckQhOU!aijkS#O!b!cR#^#P`fOgijk!b!c#PQvTT!{!]!|`eOgijk!b!c#PSuTfQ!hvR#Z!{hdOTfgijkv!b!c!{#PR#V!mjWOTfgijkv!b!c!m!{#PX|XY!Y#mhcOTfgijkv!b!c!m#PQ}XQ!PYR#Y!{lbOTYfgijkv!b!c!m!{#PS!y!Y#mR#oXn`OTYfgijkv!Y!b!c!m!{#PT#kX#mlaOTfgijkv!Y!b!c!m!{#PS!OX#mR!QYr_OTXYfgijkv!Y!b!c!m!{#P#mQ!R]S!r!T!sQ!u!VQ!x!XQ#X!wR#a#WnaOTYfgijkv!Y!b!c!m!{#PT!OX#mR#b#WR#[!{QQORpQSSOkRrS^gOijk!b!c#PR!`g`TOgijk!b!c#PRtTfUOTgijk!]!b!c!|#PRwUQ!jyR#S!jS{W|R!p{Q!W`S!v!W#lR#l#kr^OTXYfgijkv!Y!b!c!m!{#P#mR!S^Q!U_R!t!UQ!ZbS!z!Z#nR#n#oQ!|!]R#]!|Q!_eQ!guU!}!_!g#QR#Q!h",
      nodeNames: "⚠ PhiGrammar PROGRAM LICENSE COMMENT EOL METAS META OBJECTS TABS OBJECT DECLARATION FREE_LIST LSQ FREE_NAME DOTS RSQ INLINE INLINE_TOKEN PARENTHESIZED LB ANONYMOUS RB ARRAY_STAR DATA BYTES BOOL TEXT STRING INT FLOAT HEX CHAR REGEX DOT DOT_NAME AT RHO XI SIGMA DOT_ACCESS INVERSE_DOT APPLICATION COLON ARROW ATTR_NAME CONST SLASH FOREIGN_NAME DEFINITION INLINE_EXPRESSION",
      maxTerm: 65,
      nodeProps: [
        [NodeProp.closedBy, 13,"RSQ",20,"RB"],
        [NodeProp.openedBy, 16,"LSQ",22,"LB"]
      ],
      skippedNodes: [0],
      repeatNodeCount: 13,
      tokenData: "7t~RkYZ!vpq!{qr#Qrs#Vst*wtu+Vvw+[wx+axy.]yz.bz{.g{|.l}!O1V!O!P1h!P!Q1{!Q!R3R!R![4d![!]5S!`!a5X!b!c5^!c!h3u!h!i5c!v!w6]!}#O6i#P#Q6n#Q#R6s#T#o6x~!{OT~~#QO!c~~#VO!O~~#YVOY#oZ]#o^r#ors&hs#O#o#O#P$^#P~#o~#rVOY#oZ]#o^r#ors$Xs#O#o#O#P$^#P~#o~$^Ol~~$a[rs#owx#o!Q!R%V!R!S%V!S!T%c#O#P#o#U#V#o#Y#Z#o#b#c#o#f#g#o#h#i#o#i#j%r~%YP!Q![%]~%`P!Q![#o~%fQ!Q!V%]!V!W%l~%oP!Q!W#o~%uQ!Q![%{!c!i%{~&OQ!Q![&U!c!i&U~&XQ!Q![&_!c!i&_~&bQ!Q![#o!c!i#o~&mPl~rs&p~&sQYZ&y]^*q~&|TOr&yrs']s#O&y#O#P(g#P~&y~'`TOr&yrs'os#O&y#O#P(g#P~&y~'rTOr&yrs(Rs#O&y#O#P(g#P~&y~(WTk~Or&yrs(Rs#O&y#O#P(g#P~&y~(j[rs&ywx&y!Q!R)`!R!S)`!S!T)l#O#P&y#U#V&y#Y#Z&y#b#c&y#f#g&y#h#i&y#i#j){~)cP!Q![)f~)iP!Q![&y~)oQ!Q!V)f!V!W)u~)xP!Q!W&y~*OQ!Q![*U!c!i*U~*XQ!Q![*_!c!i*_~*bQ!Q![*h!c!i*h~*kQ!Q![&y!c!i&y~*tPYZ&y~*|RS~OY*wZ]*w^~*w~+[Ov~~+aOw~~+dUOY+vZ]+v^r+vs#O+v#O#P,R#P~+v~+yPwx+|~,ROp~~,U[rs+vwx+v!Q!R,z!R!S,z!S!T-W#O#P+v#U#V+v#Y#Z+v#b#c+v#f#g+v#h#i+v#i#j-g~,}P!Q![-Q~-TP!Q![+v~-ZQ!Q!V-Q!V!W-a~-dP!Q!W+v~-jQ!Q![-p!c!i-p~-sQ!Q![-y!c!i-y~-|Q!Q![.S!c!i.S~.VQ!Q![+v!c!i+v~.bOd~~.gOf~~.lOg~~.oR!Q!R.x!R![/w#T#o0S~.}Pm~!O!P/Q~/VQn~!Q![/Q#X#Y/]~/`R{|/i}!O/i!Q![/o~/lP!Q![/o~/tPn~!Q![/o~/|Qm~!O!P/Q!Q![/w~0XUV~pq0k}!O0S!Q![0S!c!}0S#R#S0S#T#o0S~0nROY0wZ]0w^~0w~0|RV~OY0wZ]0w^~0w~1YR}!O1c!Q!R.x!R![/w~1hOi~R1mPrP!O!P1pQ1sP!O!P1vQ1{O_Q~2QR!P~OY2ZZ]2Z^~2Z~2^TOY2ZZ]2Z^!P2Z!P!Q2m!Q~2Z~2rTq~OY2ZZ]2Z^!P2Z!P!Q2m!Q~2Z~3WSm~!O!P/Q!Q![3d!c!i3d#l#m4O~3iPi~}!O3l~3oQ!Q![3u!c!i3u~3xQ!Q![3d!c!i3d~4RQ!Q![4X#T#Z4X~4^Qo~!Q![4X#T#Z4X~4iRm~!O!P/Q!Q![4r!c!i3d~4yRi~m~}!O3l!O!P/Q!Q![/w~5XO{~~5^O|~~5cOt~~5fR!Q![3d!c!d5o!d!i3d~5tQi~}!O3l!n!o5z~5}P!u!v6Q~6TP!g!h6W~6]Oj~~6`P!t!u6c~6fP!w!x6Q~6nO]~~6sO`~~6xOu~R7PT!QQ^P}!O6x!Q![6x!c!}7`#R#S6x#T#o6xP7eT^P}!O7`!Q![7`!c!}7`#R#S7`#T#o7`",
      tokenizers: [0, 1],
