var app = (function (exports) {
    ...
    */
    ...
    const parser = LRParser.deserialize({
      version: 13,
      states: "$OOVQPOOObQPO'#CgQmQPOOOOQO'#Cn'#CnOuQPO'#CoOOQO,59R,59ROzQPO,59RO!SQPO'#CbO!_QPO,59YOOQO,59Y,59YOOQO'#Cd'#CdOVQPO,59ZO!dQPO'#CjO!lQPO1G.mOOQO1G.m1G.mOOQO,58|,58|O!tQPO,58|OOQO1G.t1G.tO!yQPO1G.uOOQO,59U,59UOOQO-E6h-E6hOOQO7+$X7+$XOOQO1G.h1G.h",
      stateData: "#[~OaOS~OYPO[RO]RO~ORSOVSOXTO~OQWOTVO~OdYO~OX^Oe[O~ORSOS_OVSO~ORaO~ORSOVSO~OXeOe[O~OSfO~OQWOTVOXcieciSci~O",
      goto: "!VdPPPPPPePiPPlPPpPPPv|TXQbRZSTROZQ]URd]QQORbZQUPQ`VRc[",
      nodeNames: "⚠ PhiGrammar DOT Attr RP LP Block Decorator Mapsto RSQ LSQ Block Locator VOID",
      maxTerm: 21,
      nodeProps: [
        [NodeProp.openedBy, 4,"LP",9,"LSQ"],
        [NodeProp.closedBy, 5,"RP",10,"RSQ"]
      ],
      skippedNodes: [0],
      repeatNodeCount: 1,
      tokenData: "%f~RhXY!mYZ!mZ^!mpq!mxy#hyz#m|}#r}!O#w!O!P$S!a!b$X!b!c$^!c!}$c!}#O$t#P#Q$y#Q#R%O#T#o$c#y#z!m$f$g!m#BY#BZ!m$IS$I_!m$I|$JO!m$JT$JU!m$KV$KW!m&FU&FV!m~!r[a~XY!mYZ!mZ^!mpq!m#y#z!m$f$g!m#BY#BZ!m$IS$I_!m$I|$JO!m$JT$JU!m$KV$KW!m&FU&FV!m~#mOT~~#rOS~~#wOe~~#zP!`!a#}~$SOd~~$XOQ~~$^O]~~$cOV~~$hSR~!Q![$c!c!}$c#R#S$c#T#o$c~$yOY~~%OOX~~%RQ!Q!R%X!R![%^~%^O[~~%cP[~!Q![%^",
      tokenizers: [0],
