var app = (function (exports) {
    ...
    */
    ...
    const parser = LRParser.deserialize({
      version: 13,
      states: "2fOQOPOOO]OPO'#DcObOPO'#C_OmOPO'#DdOrOPO'#CbOzOPO'#C^O!cOPO'#C^O!hOPO'#C^QOOOOOOOOO,59},59}OOOO-E7a-E7aOOOO,5:O,5:OOOOO-E7b-E7bO!pOPO'#DfOzOPO'#DeOOOO'#Dg'#DgO!uOPO'#CeOOOO'#Ch'#ChO#|OPO'#CgO$UOPO'#CfO$ZOPO'#DeO$xOPO'#DeO%ZOPO'#CdOOOO,58x,58xOzOPO,58xO%bOPO,58xOOOO,5:Q,5:QOOOO-E7d-E7dO%gOPO,5:PO$xOPO,5:POOOO-E7e-E7eO&UOPO,59RO&^OPO,59RO!^OPO,59QOOOO'#Dn'#DnO%gOPO,5:POOOO-E7c-E7cOOOO1G.d1G.dOzOPO1G.dO&cOPO1G/kO&cOPO1G/kO'QOPO1G.mO'YOQO1G.mO'_OPO1G.mO'gOPO'#DiO(kOPO1G.lOOOO-E7l-E7lOOOO7+$O7+$OO)YOPO7+%VO)wOPO7+$XO)|OPO7+$XO*ROPO7+$XO*ZOQO7+$XO*`OPO'#ChO*tOPO'#DbO+SOPO'#C|OOOO'#DT'#DTO$xOPO'#DlO+^OPO'#D`OOOO'#D_'#D_OOOO'#Cy'#CyO+lOPO'#CyO,cOPO'#CxO,nOPO'#CwOOOO'#Cv'#CvOOOO,5:T,5:TOOOO-E7g-E7gO,sOPO'#CrOOOO<<Gs<<GsO,{OPO<<GsO)wOPO<<GsO-QOPO<<GsOOOO,59f,59fO-VOPO,59{O-dOPO,59|O-rOPO'#DOO-zOPO'#DOO.ROPO,59hO.WOPO'#DbOOOO,5:W,5:WOOOO-E7j-E7jOOOO,59e,59eO'gOPO'#DmO.fOPO,59dOOOO,59c,59cOOOO,59^,59^O.qOQO,59^O.|OPOAN=_OOOOAN=_AN=_O/UOPOAN=_O/ZOPO'#DjO/`OPO,59jOOOO,59j,59jO/hOPO1G/SOOOO,5:X,5:XOOOO-E7k-E7kO/vOPO'#DhO/{OQO1G.xOOOO1G.x1G.xO0WOPO1G.xO)wOPOG22yO0]OPOG22yO$xOPO'#DPOOOO,5:U,5:UOOOO-E7h-E7hO$xOPO'#DkO0eOPO7+$nOOOO,5:S,5:SOOOO-E7f-E7fOOOO7+$d7+$dO0sOPO7+$dOOOOLD(eLD(eO)wOPOLD(eO0xOPO,59kOOOO,5:V,5:VOOOO-E7i-E7iOOOO<<HO<<HOOOOO!$'LP!$'LPO'gOPO1G/VOOOO1G.m1G.mO0}OPO7+$qOOOO7+$X7+$XOOOO<<H]<<H]OOOOG22yG22yO1SOPO,59RO1[OPO1G.mO1dOPO<<GsO1iOPOAN=_O1nOPO'#CgO1vOPO,59RO1{OPO7+$XO2QOPO<<GsO2VOQO1G.mO2[OQO7+$X",
      stateData: "2a~OSPOTTOVRO~OTXO~OSPOTRXVRX~OTZO~OVROTUX~OS]O]aO^aO_aO`aOaaO!d_O~OThO~OThOVRO~OTjO~O!d_O]XX^XX_XX`XXaXXqXXvXXxXXyXXzXX{XX|XX}XX!OXX!PXX!QXX~ObpO!doO~OTqO~OTrOS!XX]!XX^!XX_!XX`!XXa!XX!c!XX!d!XX~O]aO^aO_aO`aOaaO~O!cWX~PzOTvO~OTrOS!Xa]!Xa^!Xa_!Xa`!Xaa!Xa!c!Xa!d!Xa~OczOeyO~O!d{O~OTrOS!Xi]!Xi^!Xi_!Xi`!Xia!Xi!c!Xi!d!Xi~O!d!ROTZi~Od!SO~Oc!UOe!TO~O]!VO^aO_aO`aOa!VOq!XOv!ZOx!YOy!YOz!YO{!YO|!YO}!YO!O!YO!P!YO!Q!YO~O!d_OSYiTYi]Yi^Yi_Yi`YiaYi!cYi~OTrOS!Xq]!Xq^!Xq_!Xq`!Xqa!Xq!c!Xq!d!Xq~Og!eO~O!d!gO~O!d!hOTZq~Od!iO~Oo!jOT[Xb[Xv[X!d[Xt[X~ObpOv!kO!doOT!UX~Og!eOu!nO~P'gOv!ZOT!SX!d!SXt!SX~Oq!XOv!ZOx!YOy!YOz!YO{!YO|!YO}!YO!O!YO!P!YO!Q!YO~P$xO!d!tOTlXtlX~OT!vO~Oa!xOi!wO~Oe!yO~O!d!{O~OT!Ta!d!Tat!Ta~P$xOv!ZOT!Ua!d!Uat!Ua~O!d!|OtrX~OtrX~P'gOt#PO~Ov!kOt!UX!d!UXT!UX~O!d!tOTlatla~Oh#VOi#UO!d#SO~O!d#WOTZ!R~Oe#XO~Oq#YO~O!d!|Otra~Ov#]OTpi!dpitpi~Oa#_O~Oh#bOi#aO!d#SO~Oi#aO~O!d#dOTZ!Z~Ov#]OTpq!dpqtpq~Oi#hO~O!d#jO~Ot#nO~Oc#xOe#kO~Oc#yOe#mO~Oe!zO~Oe#oO~Ob#uO!d#pO~O!d#qO~O!d#rO~O!d#sO~Od#vO~Od#wO~O",
      goto: "(W!cPP!d!gPP!jP!p!y#W#h#uPPPPPPPPP$dPPP$s#e$v%S%]P%dP%n%qPPP%dPPPPPPPPP%d%t%t%t%|&S&Z&c&l&x'O'U'['b'r'xRWORVOQUORiVQgTQuhR!PvWeTfhvQm^T|q}WdTfhvSl^eQxmR!b|`cT^efhmv|R#e#Y^bT^efhmvQ!W|Y!p!X!_!n!t#jS!q!Z!kQ#f#]R#t#YQ!f!RQ!m!XQ!z!hQ#c#WR#i#dR!c|Q!a|Q!o!XQ#O!nR#l#jW!`|!X!n#jR#Q!tZ!_|!X!n!t#jY!^|!X!n!t#jR!s!_R!o!XR#Z!|]!]|!X!_!n!t#jQQORYQSSOVR[SUfThvRtfW^TfhvRk^^`T^fhqv}Rn`Q#T!xR#`#TQ}qR!d}Q!}!mR#[!}Q#^#PR#g#^[![|!X!_!n!t#jS!l!W!pT!r![!lQ!u!`R#R!uQsdQwlU!Osw!QR!Qx",
      nodeNames: "⚠ PhiGrammar PROGRAM LICENSE COMMENT EOL METAS META OBJECTS SPACES OBJECT DECLARATION DOT_NAME AT RHO XI SIGMA FREE_NAME CONST SLASH FOREIGN_NAME ARROW FREE_LIST LSQ DOTS RSQ DEFINITION INLINE_EXPRESSION INLINE INLINE_TOKEN ARGUMENT COLON PARENTHESIZED LB ANONYMOUS INLINE_ATTRIBUTE RB ARRAY_STAR DOT DATA BYTES BOOL TEXT STRING INT FLOAT HEX CHAR REGEX ACTION DOT_ACCESS INVERSE_DOT APPLICATION",
      maxTerm: 66,
      nodeProps: [
        [NodeProp.closedBy, 23,"RSQ",33,"RB"],
        [NodeProp.openedBy, 25,"LSQ",36,"LB"]
      ],
      skippedNodes: [0],
      repeatNodeCount: 12,
      tokenData: "7Y~RkYZ!vpq!{qr#Qrs#Vst*wtu+Vvw+[wx+axy.]yz.bz{.g{|.l}!O1S!O!P1e!P!Q1x!Q!R3O!R![4a![!]5P!`!a5U!b!c5Z!c!h3r!h!i5`!v!w6Y!}#O6f#P#Q6k#Q#R6p#T#o6u~!{OT~~#QO!d~~#VOb~~#YVOY#oZ]#o^r#ors&hs#O#o#O#P$^#P~#o~#rVOY#oZ]#o^r#ors$Xs#O#o#O#P$^#P~#o~$^O{~~$a[rs#owx#o!Q!R%V!R!S%V!S!T%c#O#P#o#U#V#o#Y#Z#o#b#c#o#f#g#o#h#i#o#i#j%r~%YP!Q![%]~%`P!Q![#o~%fQ!Q!V%]!V!W%l~%oP!Q!W#o~%uQ!Q![%{!c!i%{~&OQ!Q![&U!c!i&U~&XQ!Q![&_!c!i&_~&bQ!Q![#o!c!i#o~&mP{~rs&p~&sQYZ&y]^*q~&|TOr&yrs']s#O&y#O#P(g#P~&y~'`TOr&yrs'os#O&y#O#P(g#P~&y~'rTOr&yrs(Rs#O&y#O#P(g#P~&y~(WTz~Or&yrs(Rs#O&y#O#P(g#P~&y~(j[rs&ywx&y!Q!R)`!R!S)`!S!T)l#O#P&y#U#V&y#Y#Z&y#b#c&y#f#g&y#h#i&y#i#j){~)cP!Q![)f~)iP!Q![&y~)oQ!Q!V)f!V!W)u~)xP!Q!W&y~*OQ!Q![*U!c!i*U~*XQ!Q![*_!c!i*_~*bQ!Q![*h!c!i*h~*kQ!Q![&y!c!i&y~*tPYZ&y~*|RS~OY*wZ]*w^~*w~+[O_~~+aO`~~+dUOY+vZ]+v^r+vs#O+v#O#P,R#P~+v~+yPwx+|~,RO!P~~,U[rs+vwx+v!Q!R,z!R!S,z!S!T-W#O#P+v#U#V+v#Y#Z+v#b#c+v#f#g+v#h#i+v#i#j-g~,}P!Q![-Q~-TP!Q![+v~-ZQ!Q!V-Q!V!W-a~-dP!Q!W+v~-jQ!Q![-p!c!i-p~-sQ!Q![-y!c!i-y~-|Q!Q![.S!c!i.S~.VQ!Q![+v!c!i+v~.bOq~~.gOt~~.lOu~~.oR!Q!R.x!R![/w#T#o0S~.}P|~!O!P/Q~/VQ}~!Q![/Q#X#Y/]~/`R{|/i}!O/i!Q![/o~/lP!Q![/o~/tP}~!Q![/o~/|Q|~!O!P/Q!Q![/w~0XTV~pq0h}!O0S!Q![0S#R#S0S#T#o0S~0kROY0tZ]0t^~0t~0yRV~OY0tZ]0t^~0t~1VR}!O1`!Q!R.x!R![/w~1eOx~R1jPvP!O!P1mQ1pP!O!P1sQ1xOhQ~1}Rc~OY2WZ]2W^~2W~2ZTOY2WZ]2W^!P2W!P!Q2j!Q~2W~2oT!Q~OY2WZ]2W^!P2W!P!Q2j!Q~2W~3TS|~!O!P/Q!Q![3a!c!i3a#l#m3{~3fPx~}!O3i~3lQ!Q![3r!c!i3r~3uQ!Q![3a!c!i3a~4OQ!Q![4U#T#Z4U~4ZQ!O~!Q![4U#T#Z4U~4fR|~!O!P/Q!Q![4o!c!i3a~4vRx~|~}!O3i!O!P/Q!Q![/w~5UOo~~5ZOe~~5`O]~~5cR!Q![3a!c!d5l!d!i3a~5qQx~}!O3i!n!o5w~5zP!u!v5}~6QP!g!h6T~6YOy~~6]P!t!u6`~6cP!w!x5}~6kOg~~6pOi~~6uO^~R6|SdQaP}!O6u!Q![6u#R#S6u#T#o6u",
      tokenizers: [0, 1],
