var app = (function (exports) {
    ...
    */
    ...
    const parser = LRParser.deserialize({
      version: 13,
      states: ".|OQOPOOOfOPO'#D`OkOPO'#C_O!POPO'#DaO!UOPO'#CbO!jOPO'#DbOOOO'#Dd'#DdO!xOPO'#CeO$VOPO'#CgO$_OPO'#CfO$dOPO'#DbO$iOPO'#DbO$qOPO'#CdOOOO'#C^'#C^O!jOPO'#C^O%SOPO'#C^O%eOPO'#C^QOOOOOO%lOPO,59zO&QOPO'#D`OOOO-E7^-E7^OOOO,59{,59{OOOO-E7_-E7_O&VOPO'#DcOOOO-E7a-E7aO&[OPO,59|O$iOPO,59|OOOO-E7b-E7bO&aOPO,59RO&iOPO,59ROaOPO,59QOOOO,59|,59|OOOO-E7`-E7`OOOO,58x,58xO!jOPO,58xO&nOPO,58xOOOO,59z,59zOOOO,59},59}OOOO1G/h1G/hO'POPO1G/hO'UOPO1G.mO'^OQO1G.mO'cOPO1G.mO(oOPO'#DfO(yOPO1G.lOOOO1G.d1G.dO!jOPO1G.dOOOO7+%S7+%SO)ROPO7+$XO)WOPO7+$XO)]OPO7+$XO)eOQO7+$XO)jOPO'#CnO)rOPO'#C{OOOO'#C{'#C{O*TOPO'#DgO*fOPO'#D[O*tOPO'#CwOOOO'#DP'#DPO+OOPO'#D]OOOO'#DZ'#DZOOOO'#D^'#D^OOOO'#Ct'#CtO+^OPO'#CtO+hOPO'#CsOOOO'#Cr'#CrO+sOPO,5:QOOOO-E7d-E7dOOOO7+$O7+$OOOOO<<Gs<<GsO+xOPO<<GsO)ROPO<<GsO+}OPO<<GsOOOO,59Y,59YO,SOQO,59YOOOO,59a,59aOOOO,5:R,5:ROOOO-E7e-E7eO,_OPO'#C{O,pOPO,59cO,uOPO,59wO-SOPO,59wOOOO,59`,59`O*tOPO'#DhO-bOPO,59_OOOO1G/l1G/lO-mOPOAN=_OOOOAN=_AN=_O-uOPOAN=_O-zOPO'#DeO.POQO1G.tOOOO1G.t1G.tO.[OPO1G.tO.aOPO1G.}OOOO,5:S,5:SOOOO-E7f-E7fO)ROPOG22yO.oOPOG22yOOOO,5:P,5:POOOO-E7c-E7cOOOO7+$`7+$`O.wOPO7+$`O.|OPO7+$iOOOOLD(eLD(eO)ROPOLD(eOOOO<<Gz<<GzOOOO!$'LP!$'LP",
      stateData: "/[~OSPOT^OVRO[WO]WO!^UO~OTbO~OScOTRXVRX[RX]RX!^RX~OTeO~OVROSUXTUX[UX]UX!^UX~OSgO[WO]WO!^UO~O!^UO[XX]XXcXXlXXnXXpXXqXXrXXtXXuXXvXXwXXxXXyXXzXX{XX|XX!RXX~O^mO!^lO~OTnO~OToO~O[WO]WO~OSgO[WO]WO!^UO!]WX~OSgOTrO[WO]WO!^UO~OVRO~P%SOS!VaT!SaV!Sa[!Va]!Va!^!Va~OTtO~OTuO~OTvO~O_yOaxO~O!^zO~OSgOT!OO[WO]WO!^UO~OT!PO~O!^!QOTZi~O`!RO~O_!TOa!SO~Oc!UOl!ZOn!XOp!WOq!WOr!WOt![Ou![Ov![Ow![Ox![Oy![Oz![O{![O|![O!R!_O~O[!VO]!VO~P'kO!^UOTYi~Oc!UO~O!^!hO~O!^!iOTZq~O`!jO~O[!lOe!kO~O^mOj!mO!^lOToXnoX~O[!WO]!WOp!WOq!WOr!WO~On!XOT!OX!^!OXm!OX~O[!pO]!pO~P'kOn!rOT!PX!^!PXm!PX~O[!WO]!WO~P'kO!^!uOTgXmgX~OT!wO~Oa!xO~O!^!zO~Od#OOe!}O!^!{O~Oj!mOmoXnoX!^oXToX~Om#PO~OT!Pa!^!Pam!Pa~P*TOn!XOT!Pa!^!Pam!Pa~O!^!uOTgamga~O!^#SOTZ!R~Oa#TO~O[#UO~Od#XOe#WO!^!{O~Oe#WO~On!XOTki!^kimki~O!^#[OTZ!Z~Oe#]O~On!XOTkq!^kqmkq~O",
      goto: "'^!]PP!^!aPP!dP!j!y#[#pPPPPPP$OPPP$b$e$k$rP$wPPP%PPPP$wPPPPPPPPP$w%Z%Z$wP%a%g%n%z&X&i&o&u'WRaOR`OQ_ORs`Q]OUq^_`S}rsR!f!O`ZO[^_`rs!OQjTT{n|`YO[^_`rs!OSiTZQwjR!c{iXOTZ[^_`jrs{!OW!_{!Z!a!uQ!g!QQ!y!iQ#Z#SR#^#[R!d{Q!c{R!q!ZS!b{!ZR#Q!uV!a{!Z!uU!`{!Z!uR!t!aW!]{!Z!a!uT!n!X!rX!^{!Z!a!uQQORdQSSO`RfS^[O^_`rs!ORp[`TO[^_`rs!ORhTfVOT[^_`nrs|!ORkVQ!|!lR#V!|Q|nR!e|W!Y{!Z!a!uU!o!Y!s#YQ!s!]R#Y#PQ!v!bR#R!v",
      nodeNames: "⚠ PhiGrammar PROGRAM LICENSE COMMENT EOL METAS META OBJECTS SPACES OBJECT DECLARATION FREE_NAME AT CONST SLASH FOREIGN_NAME ARROW ATTRIBUTE_LIST LSQ DOTS RSQ DEFINITION INLINE INLINE_TOKEN ARGUMENT COLON PARENTHESIZED LB RB DOT DOT_NAME RHO XI SIGMA DATA BYTES BOOL TEXT STRING INT FLOAT HEX CHAR REGEX ACTION DOT_ACCESS MAYBE_INVERSE ANONYMOUS ARRAY_STAR",
      maxTerm: 60,
      nodeProps: [
        [NodeProp.closedBy, 19,"RSQ",28,"RB"],
        [NodeProp.openedBy, 21,"LSQ",29,"LB"]
      ],
      skippedNodes: [0],
      repeatNodeCount: 9,
      tokenData: "7Y~RkYZ!vpq!{qr#Qrs#Vst*wtu+Vvw+[wx+axy.]yz.bz{.g{|.l}!O1S!O!P1e!P!Q1x!Q!R3O!R![4a![!]5P!`!a5U!b!c5Z!c!h3r!h!i5`!v!w6Y!}#O6f#P#Q6k#Q#R6p#T#o6u~!{OT~~#QO!^~~#VO^~~#YVOY#oZ]#o^r#ors&hs#O#o#O#P$^#P~#o~#rVOY#oZ]#o^r#ors$Xs#O#o#O#P$^#P~#o~$^Ow~~$a[rs#owx#o!Q!R%V!R!S%V!S!T%c#O#P#o#U#V#o#Y#Z#o#b#c#o#f#g#o#h#i#o#i#j%r~%YP!Q![%]~%`P!Q![#o~%fQ!Q!V%]!V!W%l~%oP!Q!W#o~%uQ!Q![%{!c!i%{~&OQ!Q![&U!c!i&U~&XQ!Q![&_!c!i&_~&bQ!Q![#o!c!i#o~&mPw~rs&p~&sQYZ&y]^*q~&|TOr&yrs']s#O&y#O#P(g#P~&y~'`TOr&yrs'os#O&y#O#P(g#P~&y~'rTOr&yrs(Rs#O&y#O#P(g#P~&y~(WTv~Or&yrs(Rs#O&y#O#P(g#P~&y~(j[rs&ywx&y!Q!R)`!R!S)`!S!T)l#O#P&y#U#V&y#Y#Z&y#b#c&y#f#g&y#h#i&y#i#j){~)cP!Q![)f~)iP!Q![&y~)oQ!Q!V)f!V!W)u~)xP!Q!W&y~*OQ!Q![*U!c!i*U~*XQ!Q![*_!c!i*_~*bQ!Q![*h!c!i*h~*kQ!Q![&y!c!i&y~*tPYZ&y~*|RS~OY*wZ]*w^~*w~+[Oq~~+aOr~~+dUOY+vZ]+v^r+vs#O+v#O#P,R#P~+v~+yPwx+|~,RO{~~,U[rs+vwx+v!Q!R,z!R!S,z!S!T-W#O#P+v#U#V+v#Y#Z+v#b#c+v#f#g+v#h#i+v#i#j-g~,}P!Q![-Q~-TP!Q![+v~-ZQ!Q!V-Q!V!W-a~-dP!Q!W+v~-jQ!Q![-p!c!i-p~-sQ!Q![-y!c!i-y~-|Q!Q![.S!c!i.S~.VQ!Q![+v!c!i+v~.bOl~~.gOm~~.lO!R~~.oR!Q!R.x!R![/w#T#o0S~.}Px~!O!P/Q~/VQy~!Q![/Q#X#Y/]~/`R{|/i}!O/i!Q![/o~/lP!Q![/o~/tPy~!Q![/o~/|Qx~!O!P/Q!Q![/w~0XTV~pq0h}!O0S!Q![0S#R#S0S#T#o0S~0kROY0tZ]0t^~0t~0yRV~OY0tZ]0t^~0t~1VR}!O1`!Q!R.x!R![/w~1eOt~R1jPnP!O!P1mQ1pP!O!P1sQ1xOdQ~1}R_~OY2WZ]2W^~2W~2ZTOY2WZ]2W^!P2W!P!Q2j!Q~2W~2oT|~OY2WZ]2W^!P2W!P!Q2j!Q~2W~3TSx~!O!P/Q!Q![3a!c!i3a#l#m3{~3fPt~}!O3i~3lQ!Q![3r!c!i3r~3uQ!Q![3a!c!i3a~4OQ!Q![4U#T#Z4U~4ZQz~!Q![4U#T#Z4U~4fRx~!O!P/Q!Q![4o!c!i3a~4vRt~x~}!O3i!O!P/Q!Q![/w~5UOj~~5ZOa~~5`O]~~5cR!Q![3a!c!d5l!d!i3a~5qQt~}!O3i!n!o5w~5zP!u!v5}~6QP!g!h6T~6YOu~~6]P!t!u6`~6cP!w!x5}~6kOc~~6pOe~~6uOp~R6|S`Q[P}!O6u!Q![6u#R#S6u#T#o6u",
      tokenizers: [0, 1],
