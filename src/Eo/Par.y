...
%name pMAYBE_LINEBREAK MAYBE_LINEBREAK
%name pEOL EOL
...
MAYBE_LINEBREAK :: { Eo.Abs.MAYBE_LINEBREAK }
MAYBE_LINEBREAK
  : LINEBREAK { Eo.Abs.MAYBE_LINEBREAKLINEBREAK $1 }
  | {- empty -} { Eo.Abs.MAYBE_LINEBREAK_ }

EOL :: { Eo.Abs.EOL }
EOL
  : LINEBREAK MAYBE_LINEBREAK ListINDENT_STAR { Eo.Abs.EEOL $1 $2 $3 }
