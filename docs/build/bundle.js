var app = (function (exports) {
    ...
    */
    ...
    const parser = LRParser.deserialize({
      version: 13,
      states: "+pOQOPOOO]OPO'#CpObOPO'#C_OmOPO'#CqOrOPO'#CbOOOO'#Cr'#CrOzOPO'#C^O!YOPO'#C^OTOPO'#C^QOOOOOOOOO,59[,59[OOOO-E6n-E6nOOOO,59],59]OOOO-E6o-E6oOOOO-E6p-E6pO!_OPO'#CtO!dOPO'#CsOOOO'#Cu'#CuO!oOPO'#CeO!wOPO'#CsO!|OPO'#CdOOOO,58x,58xOzOPO,58xO!YOPO,58xOOOO,59`,59`OOOO-E6r-E6rO!wOPO,59_OOOO-E6s-E6sO#[OPO'#CgOOOO'#Cf'#CfOOOO,59_,59_OOOO-E6q-E6qOOOO1G.d1G.dOzOPO1G.dOOOO1G.y1G.yO#dOPO,59RO#lOPO,59ROOOO7+$O7+$OO#qOPO1G.mO#vOQO1G.mO#{OPO1G.mO$TOPO7+$XO$YOPO7+$XO$_OPO7+$XO$dOQO7+$XO$iOPO<<GsO$qOPO<<GsO$vOPO<<GsO${OPO<<GsOOOOAN=_AN=_O%QOPOAN=_O%]OPOAN=_O%bOPOAN=_O%jOPOAN=_O%oOPO'#CvO%tOPOG22yOOOOG22yG22yO&POPOG22yO&UOPOG22yO%tOPOG22yO&ZOPOG22yOOOO,59b,59bOOOO-E6t-E6tOOOOLD(eLD(eO&`OPOLD(eO&eOPOLD(eO&mOPOLD(eO&xOPOLD(eOOOO!$'LP!$'LPO&}OPO!$'LPO'YOPO!$'LPO'_OPO!$'LPO'gOPO!)9AkOOOO!)9Ak!)9AkO'rOPO!)9AkO'gOPO!)9AkOOOO!.K7V!.K7VO'wOPO!.K7VO'|OPO!.K7VOOOO!4/,q!4/,qO(XOPO!4/,qOOOO!9A!]!9A!]",
      stateData: "(^~OSPOTTOVRO~OTYO~OSPOTRXVRX~OT[O~OVROTUX~OS_OTTOlaO[XP~OTTO~OThO~OS_OlaO[XP~OlaO[XX~O[lO~OS_OlaO[XPkWX~O]tOlsO~O^wO`vO~OlxO~OlyO~O_zO~O^|O`{O~Oa}O~Ol!OO~Ol!PO~O_!QO~O[!SOc!RO~O`!TO~Oa!UO~Ol!VO~Ob!ZOc!YOl!WO~Ol![O~O[!]Oc!YO~O`!^O~O[!_O~Ob!bOc!aOl!WO~Oc!aO~Oa!cO~Ol!eO~Oc!fO~O[!gOc!fO~Ob!hOc!fOl!WO~Oa!iO~Ob!lOc!kOl!WO~Oc!kO~O[!mOc!kO~Ob!oOc!nOl!WO~Oc!nO~Oc!qO~Ob!rOc!qOl!WO~Oc!sO~O",
      goto: "$RkPPloPPrPx!R![!bPPPPPPPP!f!l!s#S#[#e#oRXORWOQVORgWQeUQpfRuqWcUdfqRj`QncRrjTmcjQQORZQSSOWR]SQUOU^UfqSfVWRqgUdUfqRodW`UdfqRi`YbU`dfqRkbQ!X!SW!`!X!d!j!pQ!d!]Q!j!gR!p!m",
      nodeNames: "⚠ PhiGrammar PROGRAM LICENSE COMMENT EOL METAS META OBJECTS SPACES OBJECT DECLARATION NAME CONST SLASH FOREIGN_NAME ARROW LSQ DOTS RSQ",
      maxTerm: 28,
      nodeProps: [
        [NodeProp.closedBy, 17,"RSQ"],
        [NodeProp.openedBy, 19,"LSQ"]
      ],
      skippedNodes: [0],
      repeatNodeCount: 7,
      tokenData: "%W~R[YZwpq|qr!Rst!W{|!f!O!P#w!P!Q$Y!`!a$_!b!c$d!}#O$i#P#Q$n#T#o$s~|OT~~!ROl~~!WO]~~!]RS~OY!WZ]!W^~!W~!iQ!b!c!o#T#o#c~!tPV~pq!w~!zROY#TZ]#T^~#T~#YRV~OY#TZ]#T^~#T~#hTV~pq!w}!O#c!Q![#c#R#S#c#T#o#c~#zP!O!P#}~$QP!O!P$T~$YOb~~$_O^~~$dO`~P$iO[P~$nOa~~$sOc~R$zS_Q[P}!O$s!Q![$s#R#S$s#T#o$s",
      tokenizers: [0, 1],
