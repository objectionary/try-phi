...
transMAYBE_LINEBREAK :: Eo.Abs.MAYBE_LINEBREAK -> Result
transMAYBE_LINEBREAK x = case x of
  Eo.Abs.MAYBE_LINEBREAKLINEBREAK linebreak -> failure x
  Eo.Abs.MAYBE_LINEBREAK_ -> failure x

transEOL :: Eo.Abs.EOL -> Result
transEOL x = case x of
  Eo.Abs.EEOL linebreak maybelinebreak indentstars -> failure x
