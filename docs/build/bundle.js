...
<button class=${themeClass("button")} type=submit>${view.state.phrase("go")}</button>`;
    ...
    const parser = Parser.deserialize({
      version: 13,
      states: "#rOVQPOOO_QPO'#CkQgQPOOOOQO'#Ce'#CeOoQPO'#ChOOQO,59V,59VOtQPO,59VO|QPO,59PO!RQPO,59POOQO'#C_'#C_OVQPO,59SO!RQPO'#CaO!WQPO1G.qOOQO1G.q1G.qOOQO1G.k1G.kO!`QPO1G.kO!eQPO1G.nOOQO,58{,58{OOQO-E6_-E6_OOQO7+$]7+$]OOQO7+$V7+$V",
      stateData: "!v~OWOS~OSRO`PO~OQSObTO~OYVOZWO~O]XO~OaZOb]O~OQ^O~OQSO~OaZObcO~O^dO~OYVOZWOa[ib[i^[i~O",
      goto: "}`PPPaPdPPPjPPpPPyRYSQ[URb[QQOR`YQUPQ_WRaZTROY",
      nodeNames: "⚠ PhiGrammar Attr Mapsto Locator",
      maxTerm: 18,
      skippedNodes: [0],
      repeatNodeCount: 1,
      tokenData: "%R~RfXY!gYZ!gZ^!gpq!gxy#byz#g|}#l}!O#q!O!P#|!c!}$R!}#O$a#P#Q$f#Q#R$k#T#o$R#y#z!g$f$g!g#BY#BZ!g$IS$I_!g$I|$JO!g$JT$JU!g$KV$KW!g&FU&FV!g~!l[W~XY!gYZ!gZ^!gpq!g#y#z!g$f$g!g#BY#BZ!g$IS$I_!g$I|$JO!g$JT$JU!g$KV$KW!g&FU&FV!g~#gOZ~~#lO^~~#qOa~~#tP!`!a#w~#|O]~~$ROY~~$WRQ~!Q![$R!c!}$R#T#o$R~$fO`~~$kOb~~$nQ!Q!R$t!R![$y~$yOS~~%OPS~!Q![$y",
      tokenizers: [0],
