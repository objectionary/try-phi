var app = (function (exports) {
    ...
    */
    ...
    const parser = LRParser.deserialize({
      version: 13,
      states: "2`OQOPOOOcOPO'#DdOhOPO'#C_OyOPO'#DeO!OOPO'#CbO!aOPO'#DfO!lOPO'#CeO!tOPO'#ChO!|OPO'#CgO#UOPO'#CfO#ZOPO'#DfO#lOPO'#DfO#qOPO'#CdOOOO'#C^'#C^O!aOPO'#C^O$POPO'#C^O$_OPO'#C^QOOOOOO$pOPO'#DhO$uOPO,5:OO%WOPO'#DdOOOO-E7b-E7bOOOO,5:P,5:POOOO-E7c-E7cO%]OPO'#DgOOOO-E7e-E7eO%bOPO,5:QO#lOPO,5:QOOOO-E7f-E7fOOOO,59S,59SO%sOPO,59SO&OOPO,59RO&WOPO,59RO&`OPO,59QOOOO'#Dq'#DqO%bOPO,5:QOOOO-E7d-E7dOOOO,58x,58xO!aOPO,58xO&qOPO,58xOOOO,5:S,5:SOOOO,5:O,5:OOOOO,5:R,5:RO'POPO1G/lO'POPO1G/lO'bOPO'#DiO'gOPO1G.nOOOO1G.n1G.nO'rOPO1G.nO'wOQO'#CxOOOO,5:V,5:VO)OOPO1G.mO&ROPO'#DkOOOO-E7i-E7iO)TOQO'#CeO*bOQO'#DpO*iOPO1G.lOOOO-E7o-E7oOOOO1G.d1G.dO!aOPO1G.dO*zOPO7+%WOOOO,5:T,5:TOOOO-E7g-E7gOOOO7+$Y7+$YO+]OPO7+$YO+bOQO'#CoOOOO'#Co'#CoO,wOQO'#DOOOOO'#DS'#DSO-ROPO'#DjO-dOQO'#D_O-rOQO'#DaO.QOQO'#DaOOOO'#D^'#D^O.`OQO'#C{OOOO'#C{'#C{O.nOQO'#C{O/hOPO'#CzO/sOPO,59dO-ROPO7+$XO/xOPO'#DcOOOO'#Db'#DbOOOO,5:[,5:[OOOO-E7n-E7nOOOO7+$O7+$OOOOO<<Gt<<GtOOOO,59h,59hO/}OPO'#DPO0VOQO'#DPO0dOPO,59jOOOO,5:Y,5:YOOOO-E7l-E7lO0iOPO,59zO0vOQO,59{O-ROPO'#DjO-ROPO'#DmO1UOQO,59gO1UOQO,59gOOOO,59g,59gO'wOQO'#DoO1dOPO,59fO1oOPO1G/OO1tOQO'#CnOOOO<<Gs<<GsOOOO,59},59}O&ROPO'#DlO2SOPO,59kOOOO,59k,59kOOOO1G/U1G/UOOOO,5:U,5:UOOOO-E7h-E7hOOOO,5:X,5:XOOOO-E7k-E7kO2[OQO1G/ROOOO,5:Z,5:ZOOOO-E7m-E7mO-ROPO7+$jO2jOQO,59YO2xOPO,59YO2pOPO,59YOOOO,5:W,5:WOOOO-E7j-E7jO2}OPO<<HUO3SOPO1G.tO3XOPO1G.tO3aOSO1G.tOOOOAN=pAN=pO3fOSO7+$`O3kOPO7+$`OOOO7+$`7+$`OOOO<<Gz<<GzO3pOSO<<GzOOOOAN=fAN=f",
      stateData: "3u~OSPOT^OVRO]VO!gbO~OTcO~OSdOTRXVRX]RX!gRX~OTfO~OVROSUXTUX]UX!gUX~OShO]VO!gbO~O!gbO]XX~O^nO`mO~O!goOTZX~OTqO~OTrOS!YX]!YX!f!YX!g!YX~O]VO~OShO]VO!gbO!fWX~OShOTvO]VO!gbO~OShOTvOVRO]VO!gbO~O!gxO~OS!ZaT!WaV!Wa]!Za!g!Za~OTyO~OTzO~OTrOS!Ya]!Ya!f!Ya!g!Ya~O_!QO`!PO!g}O~Oa!TOm!RO~O!g!UOTZa~O!gbOSYaTYa]Ya!fYa~OShOT!]O]VO!gbO~OTrOS!Yi]!Yi!f!Yi!g!Yi~O^!_O~O_!bO`!aO!g}O~O`!aO~O^!cOd!cOe!dOf!dOg!dOh!gOm!eOt!jOw!fOx!fOy!fOz!fO{!fO|!fO}!fO!O!fO!P!fO~O!g!qO~O!gbO]XX^XXdXXeXXfXXgXXhXXmXXtXXwXXxXXyXXzXX{XX|XX}XX!OXX!PXX~O]VO~P'wO!gbOSYiTYi]Yi!fYi~OTrOS!Yq]!Yq!f!Yq!g!Yq~O`!wO~Oq!xOhcX!gcXTcXucX~O^!cOd!cOe!dOf!dOg!dOh!gOm!eOw!fOx!fOy!fOz!fO{!fO|!fO}!fO!O!fO!P!fO~O]VOt!zO~P+sO^!dOd!dOe!dOf!dOg!dO~Oh!gO!g!RXT!RXu!RX~Oh#OO!g!TXT!TXu!TX~Oh#QO!g!TXT!TXu!TX~Oh#RO!goXToXuoX~Oh!gOm!eOt!jOw!fOx!fOy!fOz!fO{!fO|!fO}!fO!O!fO!P!fO~P-RO!g#VOTnXunX~O!g#XO~OT#[O~O!g#]OusX~OusXu!TX!g!TX~P'wOu#`O~O!g!SaT!Sau!Sa~P-ROh#QO!g!TaT!Tau!Ta~Oh#RO!goaToauoa~O!g#VOTnauna~Oa#hO~Oh#QOi#kO!g#jOTbX~O!g#]Ousa~Oh#RO!goiToiuoi~Oh#QOi#pO!g#oOTba~Oj#qO~Ou#rO~Oj#sO~O!g#tOTbi~Ok#uO~Ok#vO~Oj#wO~Ok#xO~O",
      goto: ")j!fPP!g!jPP!mP!s#S#e#y$XPPPPP$j$mPPPPPPPP%VP%^%j%sP%z&UPP%zPPPPPPPPP&X&c&c&c&k#v&n&t&{'X'f'y(P(](c(i(s)O)U)[RaOR`OQ_ORw`Q]OUu^_`S![vwR!v!]`ZO[^_`vw!]QkTT!Xq!Y`YO[^_`vw!]SjTZQ|kR!s!XiXOTZ[^_`kvw!X!]hWOTZ[^_`kvw!X!]R!y!eR#Z!q[!i!R!X!e!n!z#VQ!|!gQ#Y!qS#a#O#QQ#c#RR#n#hS!So!UR#l#]Q!p!RQ!r!XQ!{!eR#_!zW!o!R!X!e!zR#f#VZ!n!R!X!e!z#VY!l!R!X!e!z#VR#T!nR!{!eY!m!R!X!e!z#VR#U!n]!k!R!X!e!n!z#VR!t!XQQOReQSSO`RgS^[O^_`vw!]Rt[`TO[^_`vw!]RiTbUOT[^_`vw!]SlU!WT!Wq!YQ!OnR!`!OU#P!i!j!zS#b#P#iR#i#YQpWR!VpQ#^!yR#m#^Q#S!lS#d#S#eR#e#T[!h!R!X!e!n!z#VR!}!hQ#W!oR#g#WQ!YqR!u!YQsYQ{jU!Zs{!^R!^|",
      nodeNames: "⚠ PhiGrammar PROGRAM LICENSE COMMENT EOL METAS META OBJECTS TABS OBJECT DECLARATION FREE_LIST LSQ FREE_NAME DOTS RSQ ARROW ATTR_NAME DOT_NAME AT RHO XI SIGMA DOT CONST SLASH FOREIGN_NAME INLINE_ATTRIBUTE LB INLINE INLINE_TOKEN ARGUMENT COLON PARENTHESIZED ANONYMOUS ARRAY_STAR RB DATA BYTES BOOL TEXT STRING INT FLOAT HEX CHAR REGEX ACTION DOT_ACCESS INVERSE_DOT APPLICATION DEFINITION INLINE_EXPRESSION",
      maxTerm: 69,
      nodeProps: [
        [NodeProp.closedBy, 13,"RSQ",29,"RB"],
        [NodeProp.openedBy, 16,"LSQ",37,"LB"]
      ],
      skippedNodes: [0],
      repeatNodeCount: 14,
      tokenData: "7t~RkYZ!vpq!{qr#Qrs#Vst*wtu+Vvw+[wx+axy.]yz.bz{.g{|.l}!O1V!O!P1h!P!Q1{!Q!R3R!R![4d![!]5S!`!a5X!b!c5^!c!h3u!h!i5c!v!w6]!}#O6i#P#Q6n#Q#R6s#T#o6x~!{OT~~#QO!g~~#VOi~~#YVOY#oZ]#o^r#ors&hs#O#o#O#P$^#P~#o~#rVOY#oZ]#o^r#ors$Xs#O#o#O#P$^#P~#o~$^Oz~~$a[rs#owx#o!Q!R%V!R!S%V!S!T%c#O#P#o#U#V#o#Y#Z#o#b#c#o#f#g#o#h#i#o#i#j%r~%YP!Q![%]~%`P!Q![#o~%fQ!Q!V%]!V!W%l~%oP!Q!W#o~%uQ!Q![%{!c!i%{~&OQ!Q![&U!c!i&U~&XQ!Q![&_!c!i&_~&bQ!Q![#o!c!i#o~&mPz~rs&p~&sQYZ&y]^*q~&|TOr&yrs']s#O&y#O#P(g#P~&y~'`TOr&yrs'os#O&y#O#P(g#P~&y~'rTOr&yrs(Rs#O&y#O#P(g#P~&y~(WTy~Or&yrs(Rs#O&y#O#P(g#P~&y~(j[rs&ywx&y!Q!R)`!R!S)`!S!T)l#O#P&y#U#V&y#Y#Z&y#b#c&y#f#g&y#h#i&y#i#j){~)cP!Q![)f~)iP!Q![&y~)oQ!Q!V)f!V!W)u~)xP!Q!W&y~*OQ!Q![*U!c!i*U~*XQ!Q![*_!c!i*_~*bQ!Q![*h!c!i*h~*kQ!Q![&y!c!i&y~*tPYZ&y~*|RS~OY*wZ]*w^~*w~+[Of~~+aOg~~+dUOY+vZ]+v^r+vs#O+v#O#P,R#P~+v~+yPwx+|~,RO!O~~,U[rs+vwx+v!Q!R,z!R!S,z!S!T-W#O#P+v#U#V+v#Y#Z+v#b#c+v#f#g+v#h#i+v#i#j-g~,}P!Q![-Q~-TP!Q![+v~-ZQ!Q!V-Q!V!W-a~-dP!Q!W+v~-jQ!Q![-p!c!i-p~-sQ!Q![-y!c!i-y~-|Q!Q![.S!c!i.S~.VQ!Q![+v!c!i+v~.bOm~~.gOu~~.lOt~~.oR!Q!R.x!R![/w#T#o0S~.}P{~!O!P/Q~/VQ|~!Q![/Q#X#Y/]~/`R{|/i}!O/i!Q![/o~/lP!Q![/o~/tP|~!Q![/o~/|Q{~!O!P/Q!Q![/w~0XUV~pq0k}!O0S!Q![0S!c!}0S#R#S0S#T#o0S~0nROY0wZ]0w^~0w~0|RV~OY0wZ]0w^~0w~1YR}!O1c!Q!R.x!R![/w~1hOw~R1mPhQ!O!P1pP1sP!O!P1vP1{O_P~2QRj~OY2ZZ]2Z^~2Z~2^TOY2ZZ]2Z^!P2Z!P!Q2m!Q~2Z~2rT!P~OY2ZZ]2Z^!P2Z!P!Q2m!Q~2Z~3WS{~!O!P/Q!Q![3d!c!i3d#l#m4O~3iPw~}!O3l~3oQ!Q![3u!c!i3u~3xQ!Q![3d!c!i3d~4RQ!Q![4X#T#Z4X~4^Q}~!Q![4X#T#Z4X~4iR{~!O!P/Q!Q![4r!c!i3d~4yRw~{~}!O3l!O!P/Q!Q![/w~5XOq~~5^Oa~~5cOd~~5fR!Q![3d!c!d5o!d!i3d~5tQw~}!O3l!n!o5z~5}P!u!v6Q~6TP!g!h6W~6]Ox~~6`P!t!u6c~6fP!w!x6Q~6nO]~~6sO`~~6xOe~V7PTkS^R}!O6x!Q![6x!c!}7`#R#S6x#T#o6xR7eT^R}!O7`!Q![7`!c!}7`#R#S7`#T#o7`",
      tokenizers: [0, 1, 2],
