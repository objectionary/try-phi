var app = (function (exports) {
    ...
    */
    ...
    const parser = LRParser.deserialize({
      version: 13,
      states: "3OOlOPOOOvOPO'#DdO{OPO'#C_O!mOPO'#DeO!rOPO'#CbO#dOPO'#DfOOOO'#Dh'#DhO$OOPO'#CeOOOO'#Ci'#CiO%]OPO'#ChO%hOPO'#CtO%pOPO'#CgOOOO'#Cg'#CgO%xOPO'#CfO%}OPO'#DfO&oOPO'#DfO'TOPO'#CdOOOO'#C^'#C^O#dOPO'#C^O'[OPO'#C^O'cOPO'#C^QOOOOOO'mOPO,5:OO(_OPO'#DdOOOO-E7b-E7bOOOO,5:P,5:POOOO-E7c-E7cO(dOPO'#DgOOOO-E7e-E7eO(iOPO,5:QO&oOPO,5:QOOOO-E7f-E7fO)ZOPO'#DiO)lOPO,59SO)wOPO,59SO)rOPO,59SOOOO,59`,59`O*POQO,59`O'OOPO,59RO*[OPO,59QOOOO'#Dp'#DpO(iOPO,5:QOOOO-E7d-E7dOOOO,58x,58xO#dOPO,58xO*|OPO,58xOOOO,5:O,5:OOOOO,5:R,5:RO+TOPO1G/lO+TOPO1G/lOOOO,5:T,5:TOOOO-E7g-E7gO+uOPO1G.nO+}OPO1G.nOOOO1G.n1G.nO,SOQO1G.nO,XOPO'#DjO,^OQO1G.zOOOO1G.z1G.zO,iOPO1G.zOOOO1G.m1G.mO-uOPO'#DkO-|OPO1G.lOOOO-E7n-E7nOOOO1G.d1G.dO#dOPO1G.dO.nOPO7+%WOOOO7+$Y7+$YO/`OQO7+$YO/eOPO7+$YO/mOPO7+$YOOOO,5:U,5:UOOOO-E7h-E7hOOOO7+$f7+$fO/rOPO7+$fO/wOPO'#CiO0]OPO'#DcO0nOPO'#DOOOOO'#DU'#DUO)ZOPO'#DiO0uOPO'#DaO1TOPO'#DcOOOO'#D`'#D`O1cOPO'#C{OOOO'#C{'#C{O1qOPO'#C{O2kOPO'#CzO2vOPO'#CyOOOO'#Cx'#CxOOOO,5:V,5:VOOOO-E7i-E7iOOOO7+$O7+$OO2{OPO<<GtOOOO<<Gt<<GtO3QOQO<<GtO3VOPO<<GtOOOO<<HQ<<HQOOOO,59h,59hO3[OPO,59|O3iOPO,59}O3zOPO'#DQO5ZOPO'#DQO5hOPO,59jO5mOPO'#DcOOOO,5:Y,5:YOOOO-E7l-E7lO5{OPO,59}O)ZOPO'#DmO6ZOPO,59gO6ZOPO,59gOOOO,59g,59gO4SOPO'#DoO6iOPO,59fOOOO,59e,59eO6tOPOAN=`O6yOPOAN=`OOOOAN=`AN=`O7OOPO'#DlO7TOPO,59lOOOO,59l,59lOOOO1G/U1G/UO7]OPO,59}OOOO,5:X,5:XOOOO-E7k-E7kO7kOPO1G/ROOOO,5:Z,5:ZOOOO-E7m-E7mOOOOG22zG22zO7yOPOG22zO&oOPO'#DROOOO,5:W,5:WOOOO-E7j-E7jOOOOLD(fLD(fO8OOPO,59mO4SOPO1G/XO8TOPO7+$sOOOO<<H_<<H_O8YOPO'#Cg",
      stateData: "8b~OVRO^WO_WO`WOaWObWOiYO!fUO~OSPOTbO~PQOTfO~OSgOTRXVRX^RX_RX`RXaRXbRXiRX!fRX~OTiO~OVROSUXTUX^UX_UX`UXaUXbUXiUX!fUX~OSkO^WO_WO`WOaWObWOiYO!fUO~O!fUO^XX_XX`XXaXXbXXiXXcXXsXXwXXyXXzXX{XX|XX}XX!OXX!PXX!QXX!RXX~OcpOdsO!frO~ObuOktO~O!fvOTZX~OTwO~OTxOS!YX^!YX_!YX`!YXa!YXb!YXi!YX!e!YX!f!YX~O^WO_WO`WOaWObWOiYO~O!eWX~P#dOT|O~P#dOSkOT|O~PQOS!ZaT!WaV!Wa^!Za_!Za`!Zaa!Zab!Zai!Za!f!Za~OT!OO~OT!PO~OTxOS!Ya^!Ya_!Ya`!Yaa!Yab!Yai!Ya!e!Ya!f!Ya~O^WO_WO`WOaWObWO~OcpOd!VO!f!UO~Oe!XOg!WO~Oj!]Ok![O!f!YO~O!fUOSYaTYa^Ya_Ya`YaaYabYaiYa!eYa~OT!cO~P#dOTxOS!Yi^!Yi_!Yi`!Yia!Yib!Yii!Yi!e!Yi!f!Yi~Oe!fOg!eO~O!f!gO~Of!hO~Ob!iO~Oj!lOk!kO!f!YO~Ok!kO~O^!mO_WO`WOaWOb!mOc!qOiYOs!oOy!pOz!pO{!pO|!pO}!pO!O!pO!P!pO!Q!pO!R!pO~Ow!sO~P,nO!fUOSYiTYi^Yi_Yi`YiaYibYiiYi!eYi~OTxOS!Yq^!Yq_!Yq`!Yqa!Yqb!Yqi!Yq!e!Yq!f!Yq~Of#OO~Oe#QOg#PO~O!f#RO~Ok#SO~Oq#TOT]Xc]Xd]X!f]Xv]X~Oc#UOdsO!frOT!VX!f!VX~Ow#XO~P,nOc!qOT!TX!f!TXv!TX~OcpOT!VX!f!VXv!VX~Oc#_OToX!foXvoX~Oc!qOs!oOw!sOy!pOz!pO{!pO|!pO}!pO!O!pO!P!pO!Q!pO!R!pO~P)ZO!f#cOTnXvnX~OT#eO~O!f#fO~Of#gO~Og#hO~OT!Ua!f!Uav!Ua~P)ZOcpOd!VO!f!UOT!Va!f!Va~O!f#iOvtX~O^!mO_WO`WOaWOb!mOc!qOs!oOw!sOy!pOz!pO{!pO|!pO}!pO!O!pO!P!pO!Q!pO!R!pO~OvtXv!VX!f!VX~P4SOv#lO~Oc#UOv!VX!f!VXT!VX~OcpOT!Va!f!Vav!Va~Oc#_OToa!foavoa~O!f#cOTnavna~Og#sO~O!f#tO~Os#uO~O!f#iOvta~OcpOv!Va!f!VaT!Va~Oc#_OToi!foivoi~Og#xO~O!f#zO~Ov#|O~O!fvO!fZX~O",
      goto: "*S!ePP!f!iPP!lP!r#R#d#x$Z$lPPPPPPPPPP%`PPP%u#u%x&U&_P&fP&p&sPP&fPPPPPPPPP&v'Q'Q'Q'Y'`'g's(Q(b(u({)R)X)c)n)tReORdOQcOR}dQaOU{bcdS!b|}R!}!c`_O`bcd|}!cQnTT!_w!``^O`bcd|}!cSmT_Q!RnR!z!_h]OT_`bcdn|}!_!cR#y#uhZOT_`bcdn|}!_!cR#}#uhXOT_`bcdn|}!c#uS!Sp#UQ!n!_Y#Z!o!w#X#c#zQ#[!qR#n#_j[OT_`bcdn|}!_!c#uQ!^vR#W!oR!{!_Q!y!_Q#Y!oQ#k#XR#{#zW!x!_!o#X#zR#q#cZ!w!_!o#X#c#zY!u!_!o#X#c#zR#a!wR#Y!oR#v#iY!v!_!o#X#c#zR#b!w]!t!_!o!w#X#c#zQQORhQSSOdRjS^`Obcd|}!cRz``TO`bcd|}!cRlTfVOT`bcdw|}!`!cRoVQqXW!Tq#V#^#mQ#V!nS#^!s#XR#m#ZQ!ZuR!j!ZQ!`wR!|!`Q#j#WR#w#jQ#`!uS#o#`#pR#p#a[!r!_!o!w#X#c#zR#]!rQ#d!xR#r#dQy^Q!QmU!ay!Q!dR!d!R",
      nodeNames: "⚠ PhiGrammar PROGRAM LICENSE COMMENT EOL METAS META OBJECTS SPACES OBJECT DECLARATION ATTR_NAME DOT_NAME AT RHO XI SIGMA FREE_NAME DOT CONST SLASH FOREIGN_NAME ARROW FREE_LIST LSQ DOTS RSQ DEFINITION INLINE_EXPRESSION INLINE INLINE_TOKEN ARGUMENT COLON PARENTHESIZED LB ANONYMOUS INLINE_ATTRIBUTE RB ARRAY_STAR DATA BYTES BOOL TEXT STRING INT FLOAT HEX CHAR REGEX ACTION DOT_ACCESS INVERSE_DOT APPLICATION",
      maxTerm: 68,
      nodeProps: [
