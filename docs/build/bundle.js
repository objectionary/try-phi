var app = (function (exports) {
    ...
    */
    ...
    const parser = LRParser.deserialize({
      version: 13,
      states: "1pOcOPOOOmOPO'#DdOrOPO'#C_O!ZOPO'#DeO!`OPO'#CbO!wOPO'#DfOOOO'#Dh'#DhO#YOPO'#CeO#hOPO'#ChO#pOPO'#CoO#xOPO'#CgOOOO'#Cg'#CgO$QOPO'#CfO$VOPO'#DfO$nOPO'#DfO$yOPO'#CdOOOO'#C^'#C^O!wOPO'#C^O%QOPO'#C^O%XOPO'#C^QOOOOOO%cOPO,5:OO%zOPO'#DdOOOO-E7b-E7bOOOO,5:P,5:POOOO-E7c-E7cO&POPO'#DgOOOO-E7e-E7eO&UOPO,5:QO$nOPO,5:QOOOO-E7f-E7fO&mOPO,59SO&uOPO,59SOOOO,59Z,59ZO&zOPO,59ZO$tOPO,59RO^OPO,59QOOOO'#Dp'#DpO&UOPO,5:QOOOO-E7d-E7dOOOO,58x,58xO!wOPO,58xO'VOPO,58xOOOO,5:O,5:OOOOO,5:R,5:RO'^OPO1G/lO'^OPO1G/lOOOO1G.n1G.nO'uOQO1G.nO'zOPO1G.nO(SOPO'#DiO(XOPO1G.uOOOO1G.u1G.uO(dOPO1G.uOOOO1G.m1G.mO(iOSO'#CeO*tOSO'#DjO+OOPO1G.lOOOO-E7n-E7nOOOO1G.d1G.dO!wOPO1G.dO+gOPO7+%WO,OOPO7+$YOOOO7+$Y7+$YO,TOQO7+$YOOOO,5:T,5:TOOOO-E7g-E7gOOOO7+$a7+$aO,YOPO7+$aO,_OQO'#D[O,sOSO'#CyOOOO'#DP'#DPOOOO'#D['#D[O-QOPO'#DmO-cOQO'#DaO-qOQO'#DcOOOO'#D`'#D`O.POQO'#CvOOOO'#Cv'#CvO._OSO'#CvO/UOPO'#CuO/aOPO'#CtOOOO'#Cs'#CsOOOO,5:U,5:UOOOO-E7h-E7hOOOO7+$O7+$OO/fOPO<<GtO/kOPO<<GtOOOO<<G{<<G{OOOO,59c,59cO/pOQO'#D[O0ROPO'#C{O1_OSO'#C{O1fOPO,59eOOOO,5:X,5:XOOOO-E7k-E7kO1kOPO,59|O1xOQO,59}O-QOPO'#DlO2WOQO,59bO2WOQO,59bOOOO,59b,59bO0ZOSO'#DoO2fOPO,59aOOOO,59`,59`OOOOAN=`AN=`O2qOPOAN=`O2vOPO'#DkO2{OPO,59gOOOO,59g,59gOOOO1G/P1G/POOOO,5:Y,5:YO-QOPO'#DnOOOO-E7l-E7lOOOO,5:W,5:WOOOO-E7j-E7jO3TOQO1G.|OOOO,5:Z,5:ZOOOO-E7m-E7mOOOOG22zG22zO$nOPO'#C|OOOO,5:V,5:VOOOO-E7i-E7iO3cOPO,59hO0ZOSO1G/SO3hOPO7+$nOOOO<<HY<<HYO3mOPO'#Cg",
      stateData: "3u~OVRO]WO^WOdXO!fUO~OSPOTaO~PQOTeO~OSfOTRXVRX]RX^RXdRX!fRX~OThO~OVROSUXTUX]UX^UXdUX!fUX~OSjO]WO^WOdXO!fUO~O!fUO]XX^XXdXX~O_pO!foO~O]rOfqO~O!fsOTZX~OTtO~OTuOS!YX]!YX^!YXd!YX!e!YX!f!YX~O]WO^WOdXO~O!eWX~P!wOTyO~P!wOSjOTyO~PQOS!ZaT!WaV!Wa]!Za^!Zad!Za!f!Za~OT{O~OT|O~OTuOS!Ya]!Ya^!Yad!Ya!e!Ya!f!Ya~O`!QOb!PO~O!f!RO~Oe!VOf!UO!f!SO~OT!^O~P!wOTuOS!Yi]!Yi^!Yid!Yi!e!Yi!f!Yi~Oa!`O~O`!bOb!aO~O]!cO~Oe!fOf!eO!f!SO~Of!eO~O!fUO]XX^XXdXXnXXtXXuXXvXXwXXxXXyXXzXX{XX|XX}XX!PXX!QXX!RXX~OdXOn!hOt!iOu!iOv!iOw!iOx!iOy!iOz!iO{!iO|!iO}!kO!P!jO!Q!jO!R!jO~O]!gO^!gO~P)sO!fUOSYiTYi]Yi^YidYi!eYi~OTuOS!Yq]!Yq^!Yqd!Yq!e!Yq!f!Yq~O!f!xO~Oa!yO~Of!zO~O_pOl!{O!foOT!OX}!OX!f!OX~O]!|O^!|Or#OO~P)sO]!jO^!jO!P!jO!Q!jO!R!jO~O}!kOT!TX!f!TXq!TX~O}#SOT!VX!f!VXq!VX~O}#UOTjX!fjXqjX~On!hOt!iOu!iOv!iOw!iOx!iOy!iOz!iO{!iO|!iO}!kO~P-QO!f#YOTiXqiX~OT#[O~Ob#]O~O!f#^O~Ol!{Oq!OX}!OX!f!OXT!OX~O!f#_OqoX~O]!|O^!|On!hOt!iOu!iOv!iOw!iOx!iOy!iOz!iO{!iO|!iO}!kO!P!jO!Q!jO!R!jO~OqoX~P0ZOq#bO~OT!Ua!f!Uaq!Ua~P-QO}#dOT!Va!f!Vaq!Va~O}#UOTja!fjaqja~O!f#YOTiaqia~Ob#kO~On#lO~O!f#_Oqoa~O}#UOTji!fjiqji~O!f#pO~Oq#rO~O!fsO!fZX~O",
      goto: ")h!ePP!f!iPP!lP!r#R#d#x$ZPPPPPP$lPPP%R#u%U%b%kP%rP%|&PPP%rPPPPPPPPPP&SPPP&f&p&p&p&x'O'V'c'p(T(Z(a(g(q(|)S)YRdORcOQbORzcQ`OUxabcS!]yzR!w!^`^O_abcyz!^QmTT!Yt!Z`]O_abcyz!^SlT^Q!OmR!t!Yh[OT^_abcmyz!Y!^R#o#lhYOT^_abcmyz!Y!^R#s#ljZOT^_abcmyz!Y!^#lQ!WsR!}!hR!u!YQ!s!YQ#P!hQ#a#OR#q#pW!r!Y!h#O#pR#i#YZ!q!Y!h#O#Y#pY!o!Y!h#O#Y#pR#W!qR#P!hR#m#_[!m!Y!h!q#O#Y#pQ#Q!kS#c#S#dR#f#UY!p!Y!h#O#Y#pR#X!q]!n!Y!h!q#O#Y#pQQORgQSSOcRiS^_Oabcyz!^Rw_`TO_abcyz!^RkTbVOT_abcyz!^SnV!XT!Xt!ZQ!TrR!d!TQ!ZtR!v!ZQ#`!}R#n#`Q#V!oS#g#V#hR#h#W[!l!Y!h!q#O#Y#pR#R!lQ#T!mR#e#TQ#Z!rR#j#ZQv]Q}lU![v}!_R!_!O",
      nodeNames: "⚠ PhiGrammar PROGRAM LICENSE COMMENT EOL METAS META OBJECTS SPACES OBJECT DECLARATION ATTR_NAME FREE_NAME AT CONST SLASH FOREIGN_NAME ARROW FREE_LIST LSQ DOTS RSQ DEFINITION INLINE_EXPRESSION INLINE INLINE_TOKEN ARGUMENT COLON PARENTHESIZED LB ANONYMOUS INLINE_ATTRIBUTE RB ARRAY_STAR DATA BYTES BOOL TEXT STRING INT FLOAT HEX CHAR REGEX DOT DOT_NAME RHO XI SIGMA ACTION DOT_ACCESS INVERSE_DOT APPLICATION",
      maxTerm: 68,
      nodeProps: [
        [NodeProp.closedBy, 20,"RSQ",30,"RB"],
        [NodeProp.openedBy, 22,"LSQ",33,"LB"]
      ],
      skippedNodes: [0],
      repeatNodeCount: 13,
      tokenData: "7Y~RkYZ!vpq!{qr#Qrs#Vst*wtu+Vvw+[wx+axy.]yz.bz{.g{|.l}!O1S!O!P1e!P!Q1x!Q!R3O!R![4a![!]5P!`!a5U!b!c5Z!c!h3r!h!i5`!v!w6Y!}#O6f#P#Q6k#Q#R6p#T#o6u~!{OT~~#QO!f~~#VO_~~#YVOY#oZ]#o^r#ors&hs#O#o#O#P$^#P~#o~#rVOY#oZ]#o^r#ors$Xs#O#o#O#P$^#P~#o~$^Ow~~$a[rs#owx#o!Q!R%V!R!S%V!S!T%c#O#P#o#U#V#o#Y#Z#o#b#c#o#f#g#o#h#i#o#i#j%r~%YP!Q![%]~%`P!Q![#o~%fQ!Q!V%]!V!W%l~%oP!Q!W#o~%uQ!Q![%{!c!i%{~&OQ!Q![&U!c!i&U~&XQ!Q![&_!c!i&_~&bQ!Q![#o!c!i#o~&mPw~rs&p~&sQYZ&y]^*q~&|TOr&yrs']s#O&y#O#P(g#P~&y~'`TOr&yrs'os#O&y#O#P(g#P~&y~'rTOr&yrs(Rs#O&y#O#P(g#P~&y~(WTv~Or&yrs(Rs#O&y#O#P(g#P~&y~(j[rs&ywx&y!Q!R)`!R!S)`!S!T)l#O#P&y#U#V&y#Y#Z&y#b#c&y#f#g&y#h#i&y#i#j){~)cP!Q![)f~)iP!Q![&y~)oQ!Q!V)f!V!W)u~)xP!Q!W&y~*OQ!Q![*U!c!i*U~*XQ!Q![*_!c!i*_~*bQ!Q![*h!c!i*h~*kQ!Q![&y!c!i&y~*tPYZ&y~*|RS~OY*wZ]*w^~*w~+[O!Q~~+aO!R~~+dUOY+vZ]+v^r+vs#O+v#O#P,R#P~+v~+yPwx+|~,RO{~~,U[rs+vwx+v!Q!R,z!R!S,z!S!T-W#O#P+v#U#V+v#Y#Z+v#b#c+v#f#g+v#h#i+v#i#j-g~,}P!Q![-Q~-TP!Q![+v~-ZQ!Q!V-Q!V!W-a~-dP!Q!W+v~-jQ!Q![-p!c!i-p~-sQ!Q![-y!c!i-y~-|Q!Q![.S!c!i.S~.VQ!Q![+v!c!i+v~.bOn~~.gOq~~.lOr~~.oR!Q!R.x!R![/w#T#o0S~.}Px~!O!P/Q~/VQy~!Q![/Q#X#Y/]~/`R{|/i}!O/i!Q![/o~/lP!Q![/o~/tPy~!Q![/o~/|Qx~!O!P/Q!Q![/w~0XTV~pq0h}!O0S!Q![0S#R#S0S#T#o0S~0kROY0tZ]0t^~0t~0yRV~OY0tZ]0t^~0t~1VR}!O1`!Q!R.x!R![/w~1eOt~V1jP}U!O!P1mP1pP!O!P1sP1xOeP~1}R`~OY2WZ]2W^~2W~2ZTOY2WZ]2W^!P2W!P!Q2j!Q~2W~2oT|~OY2WZ]2W^!P2W!P!Q2j!Q~2W~3TSx~!O!P/Q!Q![3a!c!i3a#l#m3{~3fPt~}!O3i~3lQ!Q![3r!c!i3r~3uQ!Q![3a!c!i3a~4OQ!Q![4U#T#Z4U~4ZQz~!Q![4U#T#Z4U~4fRx~!O!P/Q!Q![4o!c!i3a~4vRt~x~}!O3i!O!P/Q!Q![/w~5UOl~~5ZOb~~5`O^~~5cR!Q![3a!c!d5l!d!i3a~5qQt~}!O3i!n!o5w~5zP!u!v5}~6QP!g!h6T~6YOu~~6]P!t!u6`~6cP!w!x5}~6kOd~~6pOf~~6uO!P~V6|SaQ]T}!O6u!Q![6u#R#S6u#T#o6u",
      tokenizers: [0, 1, 2],
