...
<button class=${themeClass("button")} type=submit>${view.state.phrase("go")}</button>`;
    ...
    ***************************************************************************** */
    ...
    const specnormalIdentifier = {__proto__:null,name:292, dialect:294, _:84};
    const parser = Parser.deserialize({
      states: "GrOYOPOOO|OPO'#ErOXOO'#Ca'#CaOXOO'#FY'#FYOXOO'#Dc'#DcOXOO'#Dh'#DhOXOO'#Dr'#DrOXOO'#D|'#D|OXOO'#EO'#EOOXOO'#ER'#EROXOO'#ET'#ETO!pOPO'#ESO!zOPO'#EQOXOO'#EW'#EWOXOO'#Fy'#FyOXOO'#FW'#FWOXOO(3Bs(3BsQXOPOOO#OOPO'#C`O#YOPO'#DbO#^OPO'#DgO#bOPO'#DtOXOO'#D{'#D{O#ROPO'#EQO!zOPO'#D}O#fOQO'#E]OXOO,5:{,5:{OXOO,5:n,5:nO#pOPO,5:nO#wOPO'#FcO#ROPO'#FpO$ROPO'#CeOXOO,5:l,5:lOXOO'#EU'#EUOXOO'#Cb'#CbOXOO,58z,58zO!zOPO,58zO$rOPO'#DdOXOO,59|,59|O$|OPO'#DjOXOO'#Di'#DiOXOO,5:R,5:RO%^OPO'#DuOXOO,5:`,5:`O!zOPO,5:lO%hOPO,5:iO#ROPO,5:qO#wOPO,5:vO&_OPO,5:wOXOO1G0Y1G0YOXOO'#DP'#DPO&fOPO'#DOO&jOPO,5;}OXOO'#Dn'#DnO&qOPO,5<[O&xOPO'#EsO'rOPO'#CgOXOO'#DS'#DSOXOO'#D['#D[O)XOPO'#F^OXOO'#F^'#F^O*hOPO'#D]O+kOPO'#D`OXOO(3Bt(3BtOXOO'#Cf'#CfOXOO,59P,59PO,hOPO'#FbO,oOPO'#F]O,sOPO'#F]O,wOPO'#F]O,{OPO'#FhO-SOPO'#FkO$UOPO'#D]O-ZOPO,59POXOO1G.f1G.fOXOO'#De'#DeOXOO,5:O,5:OO-bOPO,5:OO-iOPO'#E}OXOO'#Dm'#DmO-yOPO'#DlO.ZOPO'#DkOXOO'#Fo'#FoOXOO(3CO(3COOXOO,5:U,5:UO.nOPO,5:UO.rOPO'#DkO.vOPO'#DqOXOO'#Dv'#DvO.zOPO'#FrOXOO,5:a,5:aO/[OPO,5:aOXOO1G0W1G0WO/cOPO'#EPOXOO1G0T1G0TOXOO'#EX'#EXO/pOQO1G0]O/tOQO1G0bOXOO'#E^'#E^O/xOPO'#E`O0POQO1G0cO0WOQO1G0eO0[OPO,59jO0lOPO'#ExO#wOPO'#EgO0sOPO1G1iO0wOPO'#FOO#ROPO'#EmO1OOPO1G1vOXOO,5:|,5:|OXOO,5;x,5;xO1SOPO'#F_O1sOPO,59zOXOO,5;|,5;|O!zOPO,5;|OXOO,5;w,5;wO1sOPO,5<SO2ZOPO,5<SO1sOPO,5<VO2_OPO,5<VO2cOPO,59wO2jOPO'#E{O$UOPO'#EjO2wOPO1G.kO2{OPO'#E|O#ROPO'#EkO3SOPO1G/jOXOO,5;W,5;WOXOO,5:W,5:WO3WOPO,5:WOXOO,5:V,5:VOXOO1G/p1G/pO3eOPO'#DpO4OOPO'#DsOXOO,5:],5:]OXOO'#Dx'#DxOXOO'#Dy'#DyOXOO'#Dz'#DzOXOO,5<^,5<^OXOO'#Dw'#DwO4YOPO'#FQO#ROPO'#EoO4aOPO1G/{OXOO,5:k,5:kO4eOPO,5:kO4iOPO7+%wO4iOPO7+%|OXOO,5:z,5:zO4mOPO,5:zO4iOPO7+%}OXOO7+%}7+%}O4iOPO7+&PO4tOPO'#EwOXOO(3Bx(3BxO#ROPO'#EfOXOO'#DQ'#DQOXOO1G/U1G/UOXOO,5;R,5;ROXOO-E8e-E8eOXOO7+'T7+'TOXOO,5;X,5;XOXOO'#Do'#DoOXOO-E8k-E8kOXOO7+'b7+'bO5[OPO'#EtOXOO'#Ck'#CkO6XOPO'#CpOXOO(3Bu(3BuOXOO'#Cj'#CjO7_OPO'#F`O7cOPO'#F`O7gOPO'#F`O7kOPO,5;yO1SOPO'#CpO7rOPO'#CiO7|OPO'#EyOXOO'#DV'#DVOXOO'#DU'#DUO8sOPO'#DXOXOO(3Bz(3BzOXOO'#DT'#DTO9sOPO'#FjO9wOPO'#FjO9{OPO'#FjO1sOPO'#DXO:POPO1G/fOXOO1G1h1G1hO:ZOPO1G1nO1sOPO1G1nO:ZOPO1G1qO1sOPO1G1qO:bOPO1G/cOXOO,5;U,5;UOXOO-E8h-E8hOXOO7+$V7+$VOXOO,5;V,5;VOXOO'#Df'#DfOXOO-E8i-E8iOXOO7+%U7+%UOXOO1G/r1G/rOXOO,5:[,5:[O:fOPO,5:[OXOO,5:_,5:_O:mOPO,5:_OXOO,5;Z,5;ZOXOO-E8m-E8mOXOO7+%g7+%gOXOO1G0V1G0VOXOO'#EY'#EYO:tOPO<<IcOXOO<<Ih<<IhO:xOPO'#FSO;POPO'#EqO;TOPO1G0fOXOO<<Ii<<IiO:tOPO<<IkOXOO,5;Q,5;QO;XOPO,5;QOXOO,5:},5:}OXOO,5;z,5;zO;]OPO'#EvO1SOPO'#EeO;dOPO1G1eO;hOPO,59[O;oOPO'#EuO1SOPO'#EdOXOO,59T,59TOXOO,5;S,5;SOXOO,5<U,5<UO;|OPO,59sO<TOPO'#EzO1sOPO'#EiO<eOPO7+%QO<lOPO7+'YO:ZOPO7+'YO<pOPO7+']O:ZOPO7+']O<tOPO7+$}O=wOPO1G/vO={OPO'#FPO#ROPO'#EnO>SOPO1G/yO>WOPO'#EZOXOOAN>}AN>}OXOO,5;],5;]OXOO-E8o-E8oOXOO7+&Q7+&QOXOOAN?VAN?VOXOO3).O3).OOXOO,5;P,5;POXOO-E8c-E8cO7rOPO'#CyOXOO7+'P7+'PO>bOPO1G.vOXOO,5;O,5;OOXOO-E8b-E8bO>fOPO1G/_OXOO,5;T,5;TOXOO-E8g-E8gOXOO<<Hl<<HlO$UOPO<<HlO1sOPO<<JtO>jOPO<<JtO1sOPO<<JwO>nOPO<<JwOXOO7+%b7+%bOXOO,5;Y,5;YOXOO-E8l-E8lOXOO7+%e7+%eOXOO,5:u,5:uO>rOPO,5:uOXOO,59e,59eO>yOPO7+$bO@POPO7+$yOAPOPOAN>WOAWOPOAN@`O1sOPOAN@`OAWOPOAN@cO1sOPOAN@cOA_OPO'#FRO#ROPO'#EpOAfOPO1G0aOAjOPOG23rOAnOPOG25zOAWOPOG25zOArOPOG25}OAWOPOG25}OXOO,5;[,5;[OXOO-E8n-E8nOXOO7+%{7+%{OXOOLD)^LD)^OXOOLD+fLD+fOAvOPOLD+fOXOOLD+iLD+iOAzOPOLD+iOXOO!$( Q!$( QOXOO!$( T!$( T",
      stateData: "BUPOSQOS#yOS~#{QO#}RO$ORO$aSO$bTO$eUO$jVO$kWO$lXO$n]O#w#fP~#{QO#}RO$ORO$aSO$bTO$eUO$jVO$kWO$lXO$n]O#w#fX~[nOqmOW!vX~WoO~WoO#}RO$ORO~WuO~WwO~WzO~$o!OO$q!PO$r!QO~qmOW!va~$O!SO$W!SO$X!SO~V!cOb!jOj!aOk!aOo!^O!T!`O#}RO$ORO$]!ZO$`![O~V!nO#}RO$ORO~V!vOo!sO#}RO$ORO$eUO~V!|O#}RO$ORO~W#PO#w!qa#{!qa#}!qa$O!qa$a!qa$b!qa$e!qa$j!qa$k!qa$l!qa$n!qa~W#VO$O#UO~$Y#YO~$T#[Ou#lP~$T#_On#rP~b!jOj!aOk!aOo!^O!T!`O#}RO$ORO$]!ZO$`![OV#gXl#gXc#gXn#gX~VZXWpX[ZXbZXeZXgZXiZXjZXkZXlZXoZXqpX!TZX#}ZX$OZX$]ZX$`ZXcZX`ZXaZXnZX$TZX~[#cOV$QXb$QXe$QXg$QXi$QXj$QXk$QXl$QXo$QX!T$QX#}$QX$O$QX$]$QX$`$QXc$QX`$QXa$QXn$QX$T$QX~V$PXb$PXe!PXg!QXi!RXj$PXk$PXl$PXo$PX!T$PX#}$PX$O$PX$]$PX$`$PXc$PXn$PX~[#dOV!SXb!SXj!SXk!SXl!SXo!SX!T!SX#}!SX$O!SX$]!SX$`!SXc!SXn!SX~WoOqmO~e#gO~g#gO~i#gO~[#hOqmO~[#jOqmO~l#nOV#oP~$T#qOV#pP~o!sO#}RO$ORO$eUOV#qX~[nOqmOW!`XV!`X$T!`X~qmOV!_Xo!_X#}!_X$O!_X$e!_X~V#wO~W#xO~W#yO~$g#{O$h#|O$i#}OV$fX$T$fX~$T$ROV#tP~V$TO#}RO$ORO$lXO~$p$VO~$p$WO~V$XO$O$YO~$p$ZO$s$[O~$p$]O~W$`Oo$_O#}RO$ORO$Z$_O~$T#[Ou#lX~u$eO~$T#_On#rX~n$iO~`$kOa$kOb$sOj$mOk$mOo!^O#}RO$ORO$]!ZO$`![O~`$kOa$kOb%OOo$wOz$wO#}RO$ORO~[%SO~[%UO~l#nOc#oP~l#nOV#oXc#oXn#oX~V%YO~$T#qOV#pX~V%^O~qmOW!`aV!`a$T!`a~V%`O`$kOa$kOb%OOo$wOz$wO#}RO$ORO~V%bO#}RO$ORO~$T$ROV#tX~V%fO~V%gO~o%hO~$T%lOV#vP~W$`Oo$_O#}RO$ORO$Z$_Ou#kX$T#kX~`$kOa$kOb$sOj$mOk$mOo!^O#}RO$ORO$]!ZO$`![Ol#hXn#hX$T#hXc#hX~`$SXa$SXb$SXedXgfXihXj$SXk$SXl$SXn$SXo$SX#}$SX$O$SX$T$SX$]$SX$`$SXc$SX~e%sO~g%sO~i%sO~$T%uOn#jP~l%yOn#iP$T#iP~`$kOa$kOb%OOo$wOz$wO#}RO$OROl#mXn#mX$T#mXV#mXc#mX~`$^Xa$^Xb$^Xe{Xg|Xi}Xl$^Xn$^Xo$^Xz$^X#}$^X$O$^X$T$^XV$^Xc$^X~e%|O~g%|O~i%|O~l&POn#nP$T#nP~l&PO$T#nP~c&VO~l&POV#nP~$T&YOV#sP~W&[O~$T%lOV#vX~$O&_O~V&`O~V&bO~$T%uOn#jX~n&fO~l%yOc#iP~l%yOn#iX$T#iXc#iX~l&POc#nP~l&POn#nX$T#nXV#nXc#nX~n&mO$T&nO~$T&oO~$T&qO~V$Pqb$Pqe!Pqg!Qqi!Rqj$Pqk$Pql$Pqo$Pq!T$Pq#}$Pq$O$Pq$]$Pq$`$Pqc$Pqn$Pq~V&sO~$T&YOV#sX~V&vO~V&wO#}RO$ORO~c&zO~c&{O~$T'OO~$T'QO~$T'SOV#uP~`$Sqa$Sqb$Sqedqgfqihqj$Sqk$Sql$Sqn$Sqo$Sq#}$Sq$O$Sq$T$Sq$]$Sq$`$Sqc$Sq~`$^qa$^qb$^qe{qg|qi}ql$^qn$^qo$^qz$^q#}$^q$O$^q$T$^qV$^qc$^q~l#nOn#oP~l&POn#nP~$T'SOV#uX~V']O~n'^O~n'_O~n'aO~n'cO~n'dO~#}!Ta$O#y~",
      goto: "7`$nPPPP$o$s$wPP$z%_%kP%w%z&WPPPP&nP&uP&|PPPP'TPP'WP'd'j'qP't(Q&_(vP)])l){*[*h*o*v*}P$o+U+Y+]+`$o+c+g+j+m+q+{,R,U,X+m,[,d$o,g,j,n,q,q,q$o,t$o,x,|-P-W-]-e-k-q-u-y-|.Y-q-q.`-q.c.f.l.u/O/W/^/d/j/{0]0e0k0q0w0}1T1Z1a1d1j1p1y1|2P2S2b3T3^3a3d3g3j3m3pPPP3sP3wPP*}5a5o5rP5y6VPPPP5yP6o5yPPP7O7SP7YPPPPPP$oT_OPTbOPRtbSq[|QsbQ}hQ!ltQ#e!dR%Q#fQ!koQ#l!jQ%X#nR&|&ne!]o!X!j#c#n$j$s%u%y&nR$r#cQ$t#cQ%w$sQ&e%uR&i%yY$l#c$j$s%u%yk$x#d#h#j#x$u%O%S%U&P&o&q'O'QZ$o#c$j$s%u%yZ$p#c$j$s%u%yZ$q#c$j$s%u%yR&d%ue!do!X!j#c#n$j$s%u%y&nQ!UmR$d#[S!Tm#[R#T!PR$b#Ye!ho!X!j#c#n$j$s%u%y&nQ%P#dQ%R#hQ%T#jQ%a#xQ%}%OQ&S%SQ&U%UQ&l&PQ&}&oQ'P&qQ'W'OR'Y'Qj$w#d#h#j#x$u%O%S%U&P&o&q'O'QQ%c#yR&u&Yk${#d#h#j#x$u%O%S%U&P&o&q'O'Qk$|#d#h#j#x$u%O%S%U&P&o&q'O'Qk$}#d#h#j#x$u%O%S%U&P&o&q'O'Qe!io!X!j#c#n$j$s%u%y&nZ!eo!X!j#n&nZ!fo!X!j#n&nZ!go!X!j#n&nZ!ao!X!j#n&nTcOPRvcR!ouR%]#qTdOPRydRxdT!tw!pS!xw!pQ&x&[R'['SX!rw!p&['SR!WnR$h#_R#v!xSeOPT!yw!pR#z!yR{eT!{z$RR$O!{R$P!{TfOPThOPR#Q}S_OPR$U#PVgOP#PU[OP#PR|gXZOPg#PQp[R#O|T^OPTiOPR#S!OQ%i$VQ%j$WQ%n$ZR%o$]Q&]%iR&a%oR#W!QR#X!QQPORjPW!Xo!j#n&nR#a!XW$j#c$s%u%yR%r$jU%x$t%w&eR&h%xQ%t$rR&c%tQ$^#YR%p$^Q#Z!UR$c#Zh$u#d#h#j#x%O%S%U&P&o&q'O'QR%{$uf&O%P%R%T%a%}&S&U&}'P'W'YR&k&OU#m!k#l&|R%W#mQ#p!oR%Z#pQ!pwR#s!pQ#^!WR$f#^Q&X%cR&t&XQ$Q!}R%d$QQ'R&xR'Z'RQ%k$YR&^%kRaOX!bo!j#n&nX$n#c$s%u%yQ%z$tQ&g%wR&y&eR%v$rR$a#YR#]!Ui$z#d#h#j#x%O%S%U&P&o&q'O'QQ&Q%PQ&R%RQ&T%TQ&W%aQ&j%}Q&p&SQ&r&UQ'V&}Q'X'PQ'`'WR'b'YQ#o!kQ%V#lR'U&|R#r!oR!wwR#`!WR&Z%cR$S!}R'T&xR%m$YT`OPWYOPg#PQrbQ!Vnd!Yo!X!j#c#n$j$s%u%y&nQ!muW!qw!p&['SS!zz$RQ#R!OS$_#Y$^Q$g#_n$v#d#h#j#x#y$u%O%S%U&P&Y&o&q'O'QQ%[#qR%q$`Y!_o!X!j#n&nZ$l#c$j$s%u%yR#b!]Z$m#c$j$s%u%ye!^o!X!j#c#n$j$s%u%y&nQkZQ!RlQ#f!dQ#i!hQ#k!iQ#t!rQ#v!sR%_#uk$y#d#h#j#x$u%O%S%U&P&o&q'O'QT!uw!pQlZR#u!rQ!}zR%e$R",
      nodeNames: "⚠ LineComment BlockComment LezerGrammar TopDefinition Keyword RuleNameDefinition } { BlockBody RuleSeq Identifier < TemplateArgument TokenOrRuleSeq RangeLiteral RangeExpression StdRangeLiteral ( ) Specifier* * Specifier? ? Specifier+ + PrecedenceMarker AmbiguityMarker | TemplateArgument > StringLiteral RuleNameDefinition [ PropAssignment PropName PropValue ] Keyword TokenSeq Token TokenName TokenAny Specifier* Specifier? Specifier+ Keyword Specifier* Specifier? Specifier+ NestedGrammarExpression NestedGrammarName DialectsDefinition Keyword BlockBody Dialect Dialect TokensDefinition Keyword TokensDefinitionBody BlockBody TokenDefinition TokenSignature TokenNameDefinition TemplateVariable TemplateVariable BlockBody TokenPrecedenceDefinition Keyword BlockBody PrecedenceDefinition BlockBody PrecedenceMarkerName PrecedenceType Keyword Keyword Keyword DetectDelimDefinition Keyword SkipDefinition Keyword BlockBody RuleDefinition Keyword RuleSignature RuleNameDefinition RuleDefinitionBody ExternalTokenDefinition Keyword ExternalTokenizerName ExternalSource BlockBody ExternalPropNameDefinition ExternalGrammarDefinition ExternalParserName ExternalSpecializationDefinition BlockBody",
      maxTerm: 173,
      nodeProps: [
        [NodeProp.top, 3,true],
        [NodeProp.openedBy, 7,"{"],
      ...
      repeatNodeCount: 17,
      tokenData: "!$`~R!VX^$hpq$hqr%]rs-Otu-rwx-xxy.gyz.lz{.q{|.v|}.{!O!P/Q!P!Q/V!^!_0c!_!`0h!`!a0m!a!b0r!b!c0w!c!};U!}#O;l#P#Q;q#R#S;v#T#X;v#X#Y<[#Y#Z?O#Z#[AW#[#b;v#b#cDz#c#d;v#d#eGx#e#g;v#g#hJQ#h#iLd#i#o;v#o#p! r#p#q! w#q#r! |#r#s!!R#y#z$h$f$g$h$g#BY;v#BY#BZ!!v#BZ$IS;v$IS$I_!!v$I_$I|;v$I|$JO!!v$JO$JT;v$JT$JU!!v$JU$KV;v$KV$KW!!v$KW&FU;v&FU&FV!!v&FV~;v~$mY#y~X^$hpq$h#y#z$h$f$g$h#BY#BZ$h$IS$I_$h$I|$JO$h$JT$JU$h$KV$KW$h&FU&FV$h~%`T!c!}%o!}#O&T#R#S%o#T#o%o$g~%o~%tTj~!Q![%o!c!}%o#R#S%o#T#o%o$g~%o~&WTp}&g!O#O&g#O#P)y#P#Q,g#Q~&g~&jUp}&g}!O&|!O#O&g#O#P)y#P#Q,g#Q~&g~'PSp}&T!O#O&T#O#P']#P~&T~'`TO#i&T#i#j'o#j#l&T#l#m)a#m~&T~'rS!Q![(O!c!i(O#T#Z(O#o#p(t~(RR!Q![([!c!i([#T#Z([~(_R!Q![(h!c!i(h#T#Z(h~(kR!Q![&T!c!i&T#T#Z&T~(wR!Q![)Q!c!i)Q#T#Z)Q~)TS!Q![)Q!c!i)Q#T#Z)Q#q#r&T~)dR!Q![)m!c!i)m#T#Z)m~)pR!Q![&T!c!i&T#T#Z&T~)|TO#i&g#i#j*]#j#l&g#l#m+}#m~&g~*`S!Q![*l!c!i*l#T#Z*l#o#p+b~*oR!Q![*x!c!i*x#T#Z*x~*{R!Q![+U!c!i+U#T#Z+U~+XR!Q![&g!c!i&g#T#Z&g~+eR!Q![+n!c!i+n#T#Z+n~+qS!Q![+n!c!i+n#T#Z+n#q#r&g~,QR!Q![,Z!c!i,Z#T#Z,Z~,^R!Q![&g!c!i&g#T#Z&g~,lU`~p}&g}!O&|!O#O&g#O#P)y#P#Q,g#Q~&g~-TUo~OY-OZr-Ors-gs#O-O#O#P-l#P~-O~-lOo~~-oPO~-O~-uP!}#O&T~-}Uo~OY-xZw-xwx-gx#O-x#O#P.a#P~-x~.dPO~-x~.lOb~~.qOc~~.vOe~~.{Oi~~/QO$T~~/VO$Z~~/YQz{/`!P!Q0T~/cROz/`z{/l{~/`~/oTOz/`z{/l{!P/`!P!Q0O!Q~/`~0TOQ~~0YRP~OY0TZ]0T^~0T~0hO[~~0mO$Y~~0rOn~~0wOg~~0zW#V#W1d#W#X1u#X#Y4W#`#a6R#d#e6j#f#g7w#g#h8f#h#i:X~1gP#i#j1j~1mP#h#i1p~1uO$i~~1xQ#X#Y2O#]#^3]~2RP#h#i2U~2XP#X#Y2[~2_P#V#W2b~2eP#h#i2h~2kP!f!g2n~2qP#X#Y2t~2wP#`#a2z~2}P#]#^3Q~3TP#a#b3W~3]O$j~~3`P#T#U3c~3fP#`#a3i~3lP#X#Y3o~3rP#V#W3u~3xP#h#i3{~4OP#g#h4R~4WO$a~~4ZP#l#m4^~4aQ#d#e4g#h#i5O~4jP#c#d4m~4pP#f#g4s~4vP#h#i4y~5OO$l~~5RP#X#Y5U~5XQ#b#c5_#f#g5j~5bP#W#X5e~5jO$`~~5mP#b#c5p~5sP#T#U5v~5yP#`#a5|~6RO$n~~6UP#X#Y6X~6[P#Y#Z6_~6bP#h#i6e~6jO$g~~6mP#f#g6p~6sP#X#Y6v~6yP#V#W6|~7PP#X#Y7S~7VP#W#X7Y~7]P#X#Y7`~7cP#b#c7f~7iP#V#W7l~7oP#X#Y7r~7wO$e~~7zP#]#^7}~8QP#Z#[8T~8WP#[#]8Z~8^P#h#i8a~8fO$h~~8iQ#_#`8o#d#e9Q~8rP#]#^8u~8xP#d#e8{~9QO$k~~9TP#X#Y9W~9ZP#V#W9^~9aP#]#^9d~9gP#T#U9j~9mP#`#a9p~9sP#]#^9v~9yP#n#o9|~:PP#X#Y:S~:XO$]~~:[P#c#d:_~:bQ#_#`:h#d#e;P~:kP#X#Y:n~:qP#b#c:t~:wP#g#h:z~;PO$b~~;UO#{~~;]T#}~$OP!Q![;U!c!};U#R#S;U#T#o;U$g~;U~;qOq~~;vOu~P;{T$OP!Q![;v!c!};v#R#S;v#T#o;v$g~;vR<aV$OP!Q![;v!c!};v#R#S;v#T#a;v#a#b<v#b#o;v$g~;vR<{V$OP!Q![;v!c!};v#R#S;v#T#d;v#d#e=b#e#o;v$g~;vR=gV$OP!Q![;v!c!};v#R#S;v#T#h;v#h#i=|#i#o;v$g~;vR>RV$OP!Q![;v!c!};v#R#S;v#T#m;v#m#n>h#n#o;v$g~;vR>oT$sQ$OP!Q![;v!c!};v#R#S;v#T#o;v$g~;vR?TV$OP!Q![;v!c!};v#R#S;v#T#f;v#f#g?j#g#o;v$g~;vR?oV$OP!Q![;v!c!};v#R#S;v#T#c;v#c#d@U#d#o;v$g~;vR@ZV$OP!Q![;v!c!};v#R#S;v#T#a;v#a#b@p#b#o;v$g~;vR@wT$pQ$OP!Q![;v!c!};v#R#S;v#T#o;v$g~;vRA]V$OP!Q![;v!c!};v#R#S;v#T#f;v#f#gAr#g#o;v$g~;vRAwU$OP!Q![;v!c!};v#R#S;v#T#UBZ#U#o;v$g~;vRB`V$OP!Q![;v!c!};v#R#S;v#T#a;v#a#bBu#b#o;v$g~;vRBzV$OP!Q![;v!c!};v#R#S;v#T#a;v#a#bCa#b#o;v$g~;vRCfU$OP!Q![;v!c!};v#R#S;v#T#UCx#U#o;v$g~;vRC}V$OP!Q![;v!c!};v#R#S;v#T#f;v#f#gDd#g#o;v$g~;vRDkT$rQ$OP!Q![;v!c!};v#R#S;v#T#o;v$g~;v~EPV$OP!Q![;v!c!};v#R#S;v#T#X;v#X#YEf#Y#o;v$g~;v~EkV$OP!Q![;v!c!};v#R#S;v#T#g;v#g#hFQ#h#o;v$g~;v~FVV$OP!Q![;v!c!};v#R#S;v#T#h;v#h#iFl#i#o;v$g~;v~FqU$OP!O!PGT!Q![;v!c!};v#R#S;v#T#o;v$g~;v~GWS!c!}Gd#R#SGd#T#oGd$g~Gd~GiT!T~!Q![Gd!c!}Gd#R#SGd#T#oGd$g~GdRG}V$OP!Q![;v!c!};v#R#S;v#T#f;v#f#gHd#g#o;v$g~;vRHiV$OP!Q![;v!c!};v#R#S;v#T#c;v#c#dIO#d#o;v$g~;vRITV$OP!Q![;v!c!};v#R#S;v#T#d;v#d#eIj#e#o;v$g~;vRIqT$qQ$OP!Q![;v!c!};v#R#S;v#T#o;v$g~;v~JVV$OP!Q![;v!c!};v#R#S;v#T#h;v#h#iJl#i#o;v$g~;v~JqV$OP!Q![;v!c!};v#R#S;v#T#W;v#W#XKW#X#o;v$g~;v~K]U$OP!O!PKo!Q![;v!c!};v#R#S;v#T#o;v$g~;v~KrS!c!}LO#R#SLO#T#oLO$g~LO~LTTa~!Q![LO!c!}LO#R#SLO#T#oLO$g~LORLiV$OP!Q![;v!c!};v#R#S;v#T#c;v#c#dMO#d#o;v$g~;vRMTV$OP!Q![;v!c!};v#R#S;v#T#_;v#_#`Mj#`#o;v$g~;vRMoV$OP!Q![;v!c!};v#R#S;v#T#X;v#X#YNU#Y#o;v$g~;vRNZV$OP!Q![;v!c!};v#R#S;v#T#b;v#b#cNp#c#o;v$g~;vRNuV$OP!Q![;v!c!};v#R#S;v#T#g;v#g#h! [#h#o;v$g~;vR! cT$oQ$OP!Q![;v!c!};v#R#S;v#T#o;v$g~;v~! wOW~~! |Ol~~!!ROV~~!!US!c!}!!b#R#S!!b#T#o!!b$g~!!b~!!gTk~!Q![!!b!c!}!!b#R#S!!b#T#o!!b$g~!!b~!!}e$OP#y~X^$hpq$h!Q![;v!c!};v#R#S;v#T#o;v#y#z$h$f$g$h$g#BY;v#BY#BZ!!v#BZ$IS;v$IS$I_!!v$I_$I|;v$I|$JO!!v$JO$JT;v$JT$JU!!v$JU$KV;v$KV$KW!!v$KW&FU;v&FU&FV!!v&FV~;v",
      tokenizers: [0, 1],
      topRules: {"LezerGrammar":[0,3]},
      specialized: [{term: 138, get: value => specnormalIdentifier[value] || -1}],
      tokenPrec: 1518
    });
