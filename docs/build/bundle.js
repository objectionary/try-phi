var app = (function (exports) {
    ...
    */
    ...
    const parser = LRParser.deserialize({
      version: 13,
      states: "3UOlOPOOOvOPO'#DdO{OPO'#C_O!mOPO'#DeO!rOPO'#CbO#dOPO'#DfO$OOPO'#CeOOOO'#Ci'#CiO%]OPO'#ChO%hOPO'#CtO%pOPO'#CgOOOO'#Cg'#CgO%xOPO'#CfO%}OPO'#DfO&oOPO'#DfO'TOPO'#CdOOOO'#C^'#C^O#dOPO'#C^O'[OPO'#C^O'cOPO'#C^QOOOOOO'mOPO'#DhO'rOPO,5:OO(dOPO'#DdOOOO-E7b-E7bOOOO,5:P,5:POOOO-E7c-E7cO(iOPO'#DgOOOO-E7e-E7eO(nOPO,5:QO&oOPO,5:QOOOO-E7f-E7fO)`OPO'#DiO)qOPO,59SO)|OPO,59SO)wOPO,59SOOOO,59`,59`O*UOQO,59`O'OOPO,59RO*aOPO,59QOOOO'#Dp'#DpO(nOPO,5:QOOOO-E7d-E7dOOOO,58x,58xO#dOPO,58xO+ROPO,58xOOOO,5:S,5:SOOOO,5:O,5:OOOOO,5:R,5:RO+YOPO1G/lO+YOPO1G/lOOOO,5:T,5:TOOOO-E7g-E7gO+zOPO1G.nO,SOPO1G.nOOOO1G.n1G.nO,XOQO1G.nO,^OPO'#DjO,cOQO1G.zOOOO1G.z1G.zO,nOPO1G.zOOOO1G.m1G.mO-zOPO'#DkO.ROPO1G.lOOOO-E7n-E7nOOOO1G.d1G.dO#dOPO1G.dO.sOPO7+%WOOOO7+$Y7+$YO/eOQO7+$YO/jOPO7+$YO/rOPO7+$YOOOO,5:U,5:UOOOO-E7h-E7hOOOO7+$f7+$fO/wOPO7+$fO/|OPO'#CiO0bOPO'#DcO0sOPO'#DOOOOO'#DU'#DUO)`OPO'#DiO0zOPO'#DaO1YOPO'#DcOOOO'#D`'#D`O1hOPO'#C{OOOO'#C{'#C{O1vOPO'#C{O2pOPO'#CzO2{OPO'#CyOOOO'#Cx'#CxOOOO,5:V,5:VOOOO-E7i-E7iOOOO7+$O7+$OO3QOPO<<GtOOOO<<Gt<<GtO3VOQO<<GtO3[OPO<<GtOOOO<<HQ<<HQOOOO,59h,59hO3aOPO,59|O3nOPO,59}O4POPO'#DQO5`OPO'#DQO5mOPO,59jO5rOPO'#DcOOOO,5:Y,5:YOOOO-E7l-E7lO6QOPO,59}O)`OPO'#DmO6`OPO,59gO6`OPO,59gOOOO,59g,59gO4XOPO'#DoO6nOPO,59fOOOO,59e,59eO6yOPOAN=`O7OOPOAN=`OOOOAN=`AN=`O7TOPO'#DlO7YOPO,59lOOOO,59l,59lOOOO1G/U1G/UO7bOPO,59}OOOO,5:X,5:XOOOO-E7k-E7kO7pOPO1G/ROOOO,5:Z,5:ZOOOO-E7m-E7mOOOOG22zG22zO8OOPOG22zO&oOPO'#DROOOO,5:W,5:WOOOO-E7j-E7jOOOOLD(fLD(fO8TOPO,59mO4XOPO1G/XO8YOPO7+$sOOOO<<H_<<H_O8_OPO'#Cg",
      stateData: "8g~OVRO^VO_VO`VOaVObVOiXO!feO~OSPOTaO~PQOTfO~OSgOTRXVRX^RX_RX`RXaRXbRXiRX!fRX~OTiO~OVROSUXTUX^UX_UX`UXaUXbUXiUX!fUX~OSkO^VO_VO`VOaVObVOiXO!feO~O!feO^XX_XX`XXaXXbXXiXXcXXsXXwXXyXXzXX{XX|XX}XX!OXX!PXX!QXX!RXX~OcpOdsO!frO~ObuOktO~O!fvOTZX~OTwO~OTxOS!YX^!YX_!YX`!YXa!YXb!YXi!YX!e!YX!f!YX~O^VO_VO`VOaVObVOiXO~O!eWX~P#dOT|O~P#dOSkOT|O~PQO!f!OO~OS!ZaT!WaV!Wa^!Za_!Za`!Zaa!Zab!Zai!Za!f!Za~OT!PO~OT!QO~OTxOS!Ya^!Ya_!Ya`!Yaa!Yab!Yai!Ya!e!Ya!f!Ya~O^VO_VO`VOaVObVO~OcpOd!WO!f!VO~Oe!YOg!XO~Oj!^Ok!]O!f!ZO~O!feOSYaTYa^Ya_Ya`YaaYabYaiYa!eYa~OT!dO~P#dOTxOS!Yi^!Yi_!Yi`!Yia!Yib!Yii!Yi!e!Yi!f!Yi~Oe!gOg!fO~O!f!hO~Of!iO~Ob!jO~Oj!mOk!lO!f!ZO~Ok!lO~O^!nO_VO`VOaVOb!nOc!rOiXOs!pOy!qOz!qO{!qO|!qO}!qO!O!qO!P!qO!Q!qO!R!qO~Ow!tO~P,sO!feOSYiTYi^Yi_Yi`YiaYibYiiYi!eYi~OTxOS!Yq^!Yq_!Yq`!Yqa!Yqb!Yqi!Yq!e!Yq!f!Yq~Of#PO~Oe#ROg#QO~O!f#SO~Ok#TO~Oq#UOT]Xc]Xd]X!f]Xv]X~Oc#VOdsO!frOT!VX!f!VX~Ow#YO~P,sOc!rOT!TX!f!TXv!TX~OcpOT!VX!f!VXv!VX~Oc#`OToX!foXvoX~Oc!rOs!pOw!tOy!qOz!qO{!qO|!qO}!qO!O!qO!P!qO!Q!qO!R!qO~P)`O!f#dOTnXvnX~OT#fO~O!f#gO~Of#hO~Og#iO~OT!Ua!f!Uav!Ua~P)`OcpOd!WO!f!VOT!Va!f!Va~O!f#jOvtX~O^!nO_VO`VOaVOb!nOc!rOs!pOw!tOy!qOz!qO{!qO|!qO}!qO!O!qO!P!qO!Q!qO!R!qO~OvtXv!VX!f!VX~P4XOv#mO~Oc#VOv!VX!f!VXT!VX~OcpOT!Va!f!Vav!Va~Oc#`OToa!foavoa~O!f#dOTnavna~Og#tO~O!f#uO~Os#vO~O!f#jOvta~OcpOv!Va!f!VaT!Va~Oc#`OToi!foivoi~Og#yO~O!f#{O~Ov#}O~O!fvO!fZX~O",
      goto: "*S!ePP!f!iPP!lP!r#R#d#x$Z$lPPPPPPPPPP%`PPP%u#u%x&U&_P&fP&p&sPP&fPPPPPPPPP&v'Q'Q'Q'Y'`'g's(Q(b(u({)R)X)c)n)tRdORcOQbOR}cQ`OU{abcS!c|}R#O!d`^O_abc|}!dQnTT!`w!a`]O_abc|}!dSmT^Q!SnR!{!`h[OT^_abcn|}!`!dR#z#vhYOT^_abcn|}!`!dR$O#vhWOT^_abcn|}!d#vS!Tp#VQ!o!`Y#[!p!x#Y#d#{Q#]!rR#o#`jZOT^_abcn|}!`!d#vQ!_vR#X!pR!|!`Q!z!`Q#Z!pQ#l#YR#|#{W!y!`!p#Y#{R#r#dZ!x!`!p#Y#d#{Y!v!`!p#Y#d#{R#b!xR#Z!pR#w#jY!w!`!p#Y#d#{R#c!x]!u!`!p!x#Y#d#{QQORhQSSOcRjS^_Oabc|}!dRz_`TO_abc|}!dRlTfUOT_abcw|}!a!dRoUQqWW!Uq#W#_#nQ#W!oS#_!t#YR#n#[Q![uR!k![Q!awR!}!aQ#k#XR#x#kQ#a!vS#p#a#qR#q#b[!s!`!p!x#Y#d#{R#^!sQ#e!yR#s#eQy]Q!RmU!by!R!eR!e!S",
      nodeNames: "⚠ PhiGrammar PROGRAM LICENSE COMMENT EOL METAS META OBJECTS TABS OBJECT DECLARATION ATTR_NAME DOT_NAME AT RHO XI SIGMA FREE_NAME DOT CONST SLASH FOREIGN_NAME ARROW FREE_LIST LSQ DOTS RSQ DEFINITION INLINE_EXPRESSION INLINE INLINE_TOKEN ARGUMENT COLON PARENTHESIZED LB ANONYMOUS INLINE_ATTRIBUTE RB ARRAY_STAR DATA BYTES BOOL TEXT STRING INT FLOAT HEX CHAR REGEX ACTION DOT_ACCESS INVERSE_DOT APPLICATION",
      maxTerm: 68,
      nodeProps: [
        [NodeProp.closedBy, 25,"RSQ",35,"RB"],
        [NodeProp.openedBy, 27,"LSQ",38,"LB"]
      ],
      skippedNodes: [0],
      repeatNodeCount: 13,
      tokenData: "7t~RkYZ!vpq!{qr#Qrs#Vst*wtu+Vvw+[wx+axy.]yz.bz{.g{|.l}!O1V!O!P1h!P!Q1{!Q!R3R!R![4d![!]5S!`!a5X!b!c5^!c!h3u!h!i5c!v!w6]!}#O6i#P#Q6n#Q#R6s#T#o6x~!{OT~~#QO!f~~#VOd~~#YVOY#oZ]#o^r#ors&hs#O#o#O#P$^#P~#o~#rVOY#oZ]#o^r#ors$Xs#O#o#O#P$^#P~#o~$^O|~~$a[rs#owx#o!Q!R%V!R!S%V!S!T%c#O#P#o#U#V#o#Y#Z#o#b#c#o#f#g#o#h#i#o#i#j%r~%YP!Q![%]~%`P!Q![#o~%fQ!Q!V%]!V!W%l~%oP!Q!W#o~%uQ!Q![%{!c!i%{~&OQ!Q![&U!c!i&U~&XQ!Q![&_!c!i&_~&bQ!Q![#o!c!i#o~&mP|~rs&p~&sQYZ&y]^*q~&|TOr&yrs']s#O&y#O#P(g#P~&y~'`TOr&yrs'os#O&y#O#P(g#P~&y~'rTOr&yrs(Rs#O&y#O#P(g#P~&y~(WT{~Or&yrs(Rs#O&y#O#P(g#P~&y~(j[rs&ywx&y!Q!R)`!R!S)`!S!T)l#O#P&y#U#V&y#Y#Z&y#b#c&y#f#g&y#h#i&y#i#j){~)cP!Q![)f~)iP!Q![&y~)oQ!Q!V)f!V!W)u~)xP!Q!W&y~*OQ!Q![*U!c!i*U~*XQ!Q![*_!c!i*_~*bQ!Q![*h!c!i*h~*kQ!Q![&y!c!i&y~*tPYZ&y~*|RS~OY*wZ]*w^~*w~+[O`~~+aOa~~+dUOY+vZ]+v^r+vs#O+v#O#P,R#P~+v~+yPwx+|~,RO!Q~~,U[rs+vwx+v!Q!R,z!R!S,z!S!T-W#O#P+v#U#V+v#Y#Z+v#b#c+v#f#g+v#h#i+v#i#j-g~,}P!Q![-Q~-TP!Q![+v~-ZQ!Q!V-Q!V!W-a~-dP!Q!W+v~-jQ!Q![-p!c!i-p~-sQ!Q![-y!c!i-y~-|Q!Q![.S!c!i.S~.VQ!Q![+v!c!i+v~.bOs~~.gOv~~.lOw~~.oR!Q!R.x!R![/w#T#o0S~.}P}~!O!P/Q~/VQ!O~!Q![/Q#X#Y/]~/`R{|/i}!O/i!Q![/o~/lP!Q![/o~/tP!O~!Q![/o~/|Q}~!O!P/Q!Q![/w~0XUV~pq0k}!O0S!Q![0S!c!}0S#R#S0S#T#o0S~0nROY0wZ]0w^~0w~0|RV~OY0wZ]0w^~0w~1YR}!O1c!Q!R.x!R![/w~1hOy~R1mPcP!O!P1pQ1sP!O!P1vQ1{OjQ~2QRe~OY2ZZ]2Z^~2Z~2^TOY2ZZ]2Z^!P2Z!P!Q2m!Q~2Z~2rT!R~OY2ZZ]2Z^!P2Z!P!Q2m!Q~2Z~3WS}~!O!P/Q!Q![3d!c!i3d#l#m4O~3iPy~}!O3l~3oQ!Q![3u!c!i3u~3xQ!Q![3d!c!i3d~4RQ!Q![4X#T#Z4X~4^Q!P~!Q![4X#T#Z4X~4iR}~!O!P/Q!Q![4r!c!i3d~4yRy~}~}!O3l!O!P/Q!Q![/w~5XOq~~5^Og~~5cO^~~5fR!Q![3d!c!d5o!d!i3d~5tQy~}!O3l!n!o5z~5}P!u!v6Q~6TP!g!h6W~6]Oz~~6`P!t!u6c~6fP!w!x6Q~6nOi~~6sOk~~6xO_~R7PTfQbP}!O6x!Q![6x!c!}7`#R#S6x#T#o6xP7eTbP}!O7`!Q![7`!c!}7`#R#S7`#T#o7`",
      tokenizers: [0, 1],
    ...
    function copyPermalink() {
        var snippet = document.getElementById(linkId).getAttribute(attributeHref);
